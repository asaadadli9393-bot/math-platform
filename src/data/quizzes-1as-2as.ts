...
export const quizzes1AS2AS: QuizSeed[] = [
  ...
  // ------------------------------------------------------------
  //  2AS - الوحدة 9: الأعداد المركبة (مقدمة)
  // ------------------------------------------------------------
  {
    id: "quiz-2as-complex-numbers",
    title: "اختبار: الأعداد المركبة (مقدمة)",
    description: "اختبر فهمك لتعريف العدد المركب، العمليات، والمرافق.",
    durationMin: 15,
    unitSlug: "2as-complex-numbers",
    questions: [
      {
        id: "q1",
        ...
        options: ["$-1$", "$1$", "$i$", "$0$"],
        correctIdx: 0,
        explanation: "بالتعريف: i² = −1.",
        points: 1,
      },
      {
        id: "q2",
        question: "ما مرافق العدد $z = 3 - 4i$؟",
        options: ["$3 + 4i$", "$-3 + 4i$", "$4 - 3i$", "$-3 - 4i$"],
        correctIdx: 0,
        explanation: "z̄ = a + bi يصبح a − bi للمرافق. مرافق 3 − 4i هو 3 + 4i.",
        points: 1,
      },
      {
        id: "q3",
        question: "ما قيمة $(2 + i)(2 - i)$؟",
        options: ["$5$", "$4$", "$3$", "$-5$"],
        correctIdx: 0,
      ...
      {
        id: "q4",
        question: "ما الطويلة (المنظم) للعدد $z = 3 + 4i$؟",
        options: ["$5$", "$7$", "$\\sqrt{7}$", "$25$"],
        correctIdx: 0,
      ...
      {
        id: "q5",
        question: "ما الجزء الحقيقي للعدد $z = -2 + 5i$؟",
        options: ["$-2$", "$5$", "$5i$", "$-2 + 5i$"],
        correctIdx: 0,
        explanation: "z = a + bi, حيث a هو الجزء الحقيقي. هنا a = −2.",
        points: 1,
      },
      {
        id: "q6",
      ...
      {
        id: "q7",
        question: "ما قيمة $\\frac{1}{i}$؟",
        options: ["$-i$", "$i$", "$-1$", "$1$"],
        correctIdx: 0,
        explanation: "1/i = i^(−1) = −i (لأن i · (−i) = −i² = 1).",
        points: 2,
      },
    ],
  },
