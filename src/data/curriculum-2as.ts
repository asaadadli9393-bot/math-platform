...
//  الفصل 1: النهايات + الدالة الأسية + الزوايا
//  الفصل 2: الجداء السلمي في الفضاء + اللوغاريتم + الاحتمالات
//  الفصل 3: المتتاليات + المعادلات التفاضلية + الأعداد المركبة
// ============================================================
...
// ============================================================
//  الوحدة 9: الأعداد المركبة (الفصل 3) — مقدمة
// ============================================================
const unit2AS_ComplexNumbers: UnitSeed = {
  slug: "2as-complex-numbers",
  title: "الأعداد المركبة (مقدمة)",
  description:
    "تعريف الأعداد المركبة، العمليات، المرافق، الطويلة. مقدمة للسنة الثالثة. (التدرّج المقرر: الفصل الثالث، المحور 9)",
  order: 9,
  icon: "Sigma",
  color: "#4338CA",
  stream: "MATHEMATICS",
  ...
  chapters: [
    {
      ...
      description: "مجموعة ℂ، العمليات، المرافق، الطويلة",
      prerequisites: "الجبر، الهندسة.",
      lessons: [
        {
          slug: "complex-basics",
          title: "العدد المركب $z = a + bi$",
          content: `## مجموعة الأعداد المركبة $\\mathbb{C}$
...
### العمليات
1. **الجمع**: $(a + bi) + (a' + b'i) = (a + a') + (b + b')i$
2. **الضرب**: $(a + bi)(a' + b'i) = (aa' - bb') + (ab' + ba')i$
3. **العكس**: $\\frac{1}{a + bi} = \\frac{a - bi}{a^2 + b^2}$
...
- $\\bar{z} = 3 - 4i$
- $|z| = \\sqrt{9 + 16} = 5$
- $z \\cdot \\bar{z} = 9 + 16 = 25 = |z|^2$ ✓
- $\\frac{1}{z} = \\frac{3 - 4i}{25} = \\frac{3}{25} - \\frac{4}{25}i$
...
- z·z̄ = |z|²`,
      ...
      exercises: [
        {
          title: "حساب مع أعداد مركبة",
          statement: "احسب $(2 + 3i)(1 - i)$ واكتب النتيجة على الشكل $a + bi$.",
          hint: "(a+bi)(c+di) = (ac-bd) + (ad+bc)i",
          solution: `$(2 + 3i)(1 - i) = 2 \\times 1 + 2 \\times (-i) + 3i \\times 1 + 3i \\times (-i)$
$= 2 - 2i + 3i - 3i^2$
$= 2 + i - 3(-1)$
$= 2 + i + 3 = 5 + i$`,
          difficulty: "INTERMEDIATE",
