...
$$\\vec{AB} \\cdot \\vec{n} = 0 \\quad \\text{و} \\quad \\vec{AC} \\cdot \\vec{n} = 0$$
...
$$x + 2y - 2z + 2 = 0 \\quad \\text{أو} \\quad x + 2y - 2z - 16 = 0$$`,
    methodology:
...
$$d < R \\implies \\text{تقاطع دائرة}$$

**الحالة 2: $|m| = R\\sqrt{3}$** (أي $m = \\pm R\\sqrt{3}$)
$$d = R \\implies \\text{تماس، تقاطع نقطة}$$
نقطة التماس = المسقط $H = \\frac{m}{3}(1, 1, 1)$.

**الحالة 3: $|m| > R\\sqrt{3}$**
$$d > R \\implies \\text{لا تقاطع (فراغ)}$$
...
نعم، $\\Omega$ على المستوى. (وفي الحقيقة هذا متوقع: $\\Omega$ هو منتصف $[AB]$، إذ $\\Omega$ مركز الكرة و $AB$ وتر.)`,
  ...
  },
  {
    ...
    hint: "1. حجم $= \\frac{1}{6}|[\\vec{AB}, \\vec{AC}, \\vec{AD}]|$. 5. $V = \\frac{1}{3} \\times \\text{قاعدة} \\times \\text{ارتفاع}$.",
...
$$\\text{فرق الثوابت} = -5 - 1 = -6, \\quad |\\vec{n}| = 3, \\quad d = \\frac{|-6|}{3} = 2$$`,
    methodology:
...
$$\\vec{n} = (2, 0, -2), \\quad \\text{نختار} \\quad \\vec{n}(1, 0, -1)$$
...
- $\\vec{v_1} = (-3, -3, 0)$
- $\\vec{v_2} = (-3, 0, -3)$
- $\\vec{n} = \\vec{v_1} \\wedge \\vec{v_2} = (-3 \\cdot -3 - 0, 0 - (-3)(-3), 0 - (-3)(0) \\text{ [نخطئ]})
...
$$\\overrightarrow{AB} = (6, 6, 6), \\quad \\text{nختار} \\quad \\vec{u} = (1, 1, 1)$$
...
$$\\Delta = 900 - 800 = 100, \\quad t = \\frac{30 \\pm 10}{2} = 20 \\text{ أو } 10$$
