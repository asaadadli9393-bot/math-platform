// ============================================================
//  بنك التمارين — الوحدة 7: دراسة الدوال الشاملة
//  السنة الثالثة ثانوي — الشعب العلمية
//  إشراف بيداغوجي: الأستاذ عدلي أسعد
// ============================================================
//  الفصل الأول: الدراسة الكاملة لدالة (100 تمرين)
//  الفصل الثاني: الدوال ذات المعامل + الأمثلية (100 تمرين)
//  المستويات: PREREQUISITE / BEGINNER / INTERMEDIATE / ADVANCED / BAC_LEVEL / BAC_EXAM
// ============================================================
...
//  الفصل الأول: الدراسة الكاملة لدالة (100 تمرين)
// ============================================================
export const bankFunctionsChapter1: ExerciseSeed[] = [
  // ----------------------------------------------------------
  //  القسم 1: مجال التعريف — 20 تمرين
  // ----------------------------------------------------------
  {
    title: "مجال التعريف 1 — دالة كسرية بسيطة",
    statement:
      "حدد مجال تعريف الدالة $f$ المعرفة بـ $f(x) = \\dfrac{1}{x-3}$.",
...
`,
    methodology:
      "لتحديد مجال تعريف دالة كسرية نستثني القيم التي تصفّي المقام. يجب دائماً كتابة الشرط صراحةً قبل كتابة المجال.",
    difficulty: "PREREQUISITE",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "دالة كسرية"],
  },
  {
    title: "مجال التعريف 2 — دالة جذرية",
    statement:
      "حدد مجال تعريف الدالة $g(x) = \\sqrt{x+5}$.",
...
`,
    methodology:
      "للجذر التربيعي الراديكاند (ما تحت الجذر) يجب أن يكون موجباً أو معدوماً. نحل المتراجحة ثم نكتب المجال بصيغة فترات.",
    difficulty: "PREREQUISITE",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "جذر تربيعي"],
  },
  {
    title: "مجال التعريف 3 — دالة لوغاريتمية",
    statement:
      "حدد مجال تعريف الدالة $h(x) = \\ln(2x - 7)$.",
...
`,
    methodology:
      "اللوغاريتم النيبيري $\\ln(u)$ معرف إذا وفقط إذا كان $u > 0$. نميّز جيداً بين $>0$ و $\\geq 0$.",
    difficulty: "PREREQUISITE",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "لوغاريتم"],
  },
  {
    title: "مجال التعريف 4 — دالة كسرية + جذرية",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{\\sqrt{x+2}}{x-1}$.",
...
`,
    methodology:
      "عند اجتماع عدة قيود نأخذ تقاطعها. نفصل الشروط بمعادلة كلية ثم نكتب المجال العام.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 3,
    tags: ["مجال التعريف", "جذر", "كسرية"],
  },
  {
    title: "مجال التعريف 5 — دالة بجذر ومقام",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{1}{\\sqrt{x^2 - 9}}$.",
...
`,
    methodology:
      "إذا كان الجذر في المقام يجب أن يكون الراديكاند موجباً تماماً (وليس فقط $\\geq 0$)، لأن القسمة على صفر ممنوعة.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 3,
    tags: ["مجال التعريف", "جذر", "مقام"],
  },
  {
    title: "مجال التعريف 6 — دالة أسية ولوغاريتمية",
    statement:
      "حدد مجال تعريف الدالة $f(x) = e^{\\ln(x-4)}$.",
...
`,
    methodology:
      "قبل أي تبسيط جبري، نحدد مجال التعريف من الشكل الأصلي للدالة. التبسيط بعد ذلك لا يوسع المجال.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "أسية", "لوغاريتم", "تبسيط"],
  },
  {
    title: "مجال التعريف 7 — دالة بمقام لوغاريتمي",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{x+1}{\\ln(x-2)}$.",
...
`,
    methodology:
      "عندما يظهر اللوغاريتم في مقام، نضيف شرط $\\ln(\\cdot) \\neq 0$ أي $\\cdot \\neq 1$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "لوغاريتم", "مقام"],
  },
  {
    title: "مجال التعريف 8 — دالة بتركيب جذور",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\sqrt{\\dfrac{x-1}{x+3}}$.",
...
`,
    methodology:
      "لمخطط إشارات كسرية: نحدد أصفار البسط (داخل المجال) والقيم الممنوعة من المقام، ثم ندرس الإشارة في كل مجال.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "جذر", "مخطط إشارات"],
  },
  {
    title: "مجال التعريف 9 — دالة بقيمة مطلقة",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{1}{|x| - 2}$.",
    hint: "ادرس إشارة $|x| - 2$.",
    solution: `
الشرط: $|x| - 2 \\neq 0 \\implies |x| \\neq 2 \\implies x \\neq 2$ و $x \\neq -2$.
...
`,
    methodology:
      "القيمة المطلقة $|x| = a \\iff x = a$ أو $x = -a$. نستعمل هذه الخاصية لحل المعادلات بالقيمة المطلقة.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "قيمة مطلقة"],
  },
  {
    title: "مجال التعريف 10 — دالة بحدّين",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\sqrt{x+1} + \\sqrt{3-x}$.",
...
`,
    methodology:
      "مجموع جذرين يتطلب تحقق شرطي كل جذر معاً. نأخذ التقاطع الذي يحقق الشروط كلها.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["مجال التعريف", "جذر", "تقاطع"],
  },
  {
    title: "مجال التعريف 11 — دالة لوغاريتم في بسط ومقام",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{\\ln(x)}{\\ln(x-1)}$.",
...
`,
    methodology:
      "عند تركيب شروط، نكتبها صراحةً واحداً تلو الآخر ثم نأخذ التقاطع. الترتيب يساعد على عدم نسيان شرط.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "لوغاريتم", "تركيب"],
  },
  {
    title: "مجال التعريف 12 — دالة بمعامل والمقام لوغاريتم",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{x^2 + 1}{\\ln(x+2) - 1}$.",
    hint: "حل $\\ln(x+2) - 1 \\neq 0$.",
    solution: `
...
`,
    methodology:
      "نلاحظ أن $\\ln(A) = 1 \\iff A = e$. هذا التحويل ضروري لحل المعادلات اللوغاريتمية.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "لوغاريتم", "أسية"],
  },
  {
    title: "مجال التعريف 13 — دالة بقوة كسرية",
    statement:
      "حدد مجال تعريف الدالة $f(x) = x^{-\\frac{1}{2}} = \\dfrac{1}{\\sqrt{x}}$.",
...
`,
    methodology:
      "القدرة الكسرية السالبة $x^{-1/2}$ تكافئ $1/\\sqrt{x}$، إذن مجالها $]0, +\\infty[$.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "قدرة كسرية"],
  },
  {
    title: "مجال التعريف 14 — دالة بمقامين",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{x+1}{(x-2)(x+5)}$.",
...
`,
    methodology:
      "نحلل المقام إلى عوامل، كل عامل يعطي قيمة ممنوعة. نستثني كل القيم التي تصفّي أي عامل.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["مجال التعريف", "تحليل"],
  },
  {
    title: "مجال التعريف 15 — دالة بتركيب معقد",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\sqrt{\\ln(3 - x)}$.",
...
`,
    methodology:
      "عند تركيب دالتين (جذر ولوغاريتم)، نطبق شروط كل دالة تباعاً ثم نأخذ التقاطع. الترتيب من الخارج للداخل.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "جذر", "لوغاريتم", "تركيب"],
  },
  {
    title: "مجال التعريف 16 — دالة بتركيب لوغاريتم وكسر",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\ln\\left(\\dfrac{x-1}{x+2}\\right)$.",
...
`,
    methodology:
      "اللوغاريتم يفرض راديكانده موجباً تماماً (لا يقبل الصفر)، لذلك نستعمل $>$ وليس $\\geq$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "لوغاريتم", "مخطط إشارات"],
  },
  {
    title: "مجال التعريف 17 — دالة بجذرين ومقام",
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\dfrac{\\sqrt{x+4}}{\\sqrt{2-x}}$.",
...
`,
    methodology:
      "الجذر في المقام يفرض موجبية تامة (لا صفر). التقاطع بين $[-4, +\\infty[$ و $]-\\infty, 2[$ يعطي $[-4, 2[$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["مجال التعريف", "جذر", "مقام"],
  },
  {
    ...
    statement:
      "حدد مجال تعريف الدالة $f(x) = \\sqrt{|x| - 3}$.",
...
`,
    methodology:
      "$|x| \\geq a$ (مع $a > 0$) تكافئ $x \\leq -a$ أو $x \\geq a$. نكتب النتيجة على شكل اتحاد فترتين.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["مجال التعريف", "قيمة مطلقة", "جذر"],
  },
  {
    title: "مجال التعريف 19 — سؤال صحيح/خطأ",
    statement:
      "هل العبارة التالية صحيحة أم خطأ؟ علّل. «إذا كان $f(x) = \\ln(x^2)$ فيكفي أن نكتب $f(x) = 2\\ln|x|$ لتعميم مجالها على $\\mathbb{R}^*$ كله.»",
...
`,
    methodology:
      "تحويل $\\ln(x^2) = 2\\ln|x|$ يحافظ على نفس المجال $\\mathbb{R}^*$، فلا يكفي دائماً أن نطبّق قاعدة $\\ln(x^n) = n\\ln x$ دون التفكير في المجال.",
    difficulty: "ADVANCED",
    type: "TRUE_FALSE",
    points: 3,
    tags: ["مجال التعريف", "لوغاريتم", "تبسيط"],
  },
  {
    title: "مجال التعريف 20 — اختيار من متعدد",
    statement:
      "مجال تعريف الدالة $f(x) = \\dfrac{1}{\\sqrt{\\ln(x-1)}}$ هو:\n\nA) $]2, +\\infty[$  \nB) $[2, +\\infty[$  \nC) $]1, 2[ \\,\\cup\\, ]2, +\\infty[$  \nD) $]2, +\\infty[$ بدون 2",
...
`,
    methodology:
      "عندما يكون الجذر في المقام، الراديكاند موجب تماماً (لا صفر). هذا يفرض $>$ وليس $\\geq$.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["مجال التعريف", "اختيار من متعدد", "جذر", "لوغاريتم"],
  },

  // ----------------------------------------------------------
  //  القسم 2: النهايات والمقاربات — 20 تمرين
  // ----------------------------------------------------------
  {
    title: "النهايات 1 — نهاية دالة كسرية عند اللانهائية",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\dfrac{3x - 1}{x + 2}$.",
...
`,
    methodology:
      "للنهاية عند $\\pm\\infty$ لدالة كسرية بدرجتين متساويتين، نقود بالحد الأعلى.",
    difficulty: "PREREQUISITE",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["نهاية", "كسرية", "لانهائية"],
  },
  {
    title: "النهايات 2 — نهاية عند قيمة منعزلة",
    statement:
      "احسب $\\lim_{x \\to 2} \\dfrac{x^2 - 4}{x - 2}$.",
...
`,
    methodology:
      "الشكل $\\dfrac{0}{0}$ غير محدد، نبسّط بتحليل البسط أو الضرب بالمرافق أو الإلغاء.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 3,
    tags: ["نهاية", "شكل غير محدد", "تحليل"],
  },
  {
    title: "النهايات 3 — نهاية دالة لوغاريتمية",
    statement:
      "احسب $\\lim_{x \\to 0^+} x \\ln(x)$.",
...
`,
    methodology:
      "الشكل $0 \\times (-\\infty)$ غير محدد. نحوّل إلى $\\dfrac{\\infty}{\\infty}$ بتغيير المتغير، ثم نستعمل قاعدة: $\\ln(x)/x \\to 0$ عند $+\\infty$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["نهاية", "لوغاريتم", "شكل غير محدد"],
  },
  {
    title: "النهايات 4 — نهاية أسية عند اللانهائية",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\dfrac{e^{2x}}{x^3}$.",
...
`,
    methodology:
      "في $+\\infty$ الأسية $e^{kx}$ (مع $k > 0$) تتفوق على كل قدرة $x^n$. نتيجة مباشرة دون حساب.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["نهاية", "أسية", "لانهائية"],
  },
  {
    title: "النهايات 5 — نهاية لوغاريتم وكسر",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\dfrac{\\ln(x)}{x^2}$.",
...
`,
    methodology:
      "نتذكر ترتيب النمو: $\\ln(x) \\ll x^\\alpha \\ll e^x$ عند $+\\infty$ (مع $\\alpha > 0$).",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["نهاية", "لوغاريتم", "نمو"],
  },
  {
    title: "النهايات 6 — نهاية بمقاربة أفقية",
    statement:
      "احسب $\\lim_{x \\to \\pm\\infty} \\dfrac{2x+1}{x^2+3}$ ثم استنتج المقاربات.",
    hint: "قِد بالحد الأعلى.",
    solution: `
بقيادة $x^2$:
...
`,
    methodology:
      "إذا كانت درجة البسط أصغر من درجة المقام، النهاية = 0 ومقاربة أفقية $y = 0$.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 3,
    tags: ["نهاية", "مقاربة أفقية"],
  },
  {
    title: "النهايات 7 — نهاية عند قيمة ممنوعة",
    statement:
      "لتكن $f(x) = \\dfrac{x+3}{x-1}$. احسب $\\lim_{x \\to 1^+} f(x)$ و $\\lim_{x \\to 1^-} f(x)$ ثم استنتج المقاربة العمودية.",
...
`,
    methodology:
      "للنهاية عند قيمة ممنوعة، ندرس إشارة البسط (التي تعطي إشارة النهاية) وإشارة المقام (التي تحدد $\\pm\\infty$ من الجانبين).",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["نهاية", "مقاربة عمودية", "إشارة"],
  },
  {
    title: "النهايات 8 — شكل $\\infty - \\infty$",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\left(\\sqrt{x^2 + 1} - x\\right)$.",
    hint: "اضرب بالمرافق.",
    solution: `
...
`,
    methodology:
      "الشكل $\\infty - \\infty$ غير محدد، نضرب بالمرافق لتحويله إلى كسر ثم ندرس النهاية.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["نهاية", "شكل غير محدد", "مرافق", "جذر"],
  },
  {
    title: "النهايات 9 — نهاية دالة أسية ولوغاريتم",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\left(1 + \\dfrac{1}{x}\\right)^x$.",
...
`,
    methodology:
      "النهاية $\\lim_{x \\to \\pm\\infty} (1 + 1/x)^x = e$ نتيجة أساسية تربط الأسية بنسبة النمو المستمر.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["نهاية", "أسية", "لوغاريتم", "نيبيري"],
  },
  {
    title: "النهايات 10 — نهاية بتركيب جذر وكسر",
    statement:
      "احسب $\\lim_{x \\to +\\infty} \\sqrt{x^2 + x} - x$.",
    hint: "اضرب بالمرافق.",
    solution: `
نضرب بالمرافق:
...
`,
    methodology:
      "عند وجود جذر ومقدار جبري، نضرب بالمرافق ثم نقود. الانتباه إلى $\\sqrt{x^2} = |x|$ عند إخراج $x$ من الجذر (موجب هنا).",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["نهاية", "مرافق", "جذر", "لانهائية"],
  },
  {
    title: "المقاربات 1 — استنتاج المقاربات من نهايات",
    statement:
      "لتكن $f(x) = \\dfrac{2x + 3}{x - 1}$. ادرس نهايات $f$ عند فروع مجالها واستنتج المقاربات.",
...
`,
    methodology:
      "الترتيب: نحسب النهايات عند فروع المجال (اللانهائية والقيم الممنوعة)، ثم نستنتج نوع المقاربة من النهاية (أفقية من نهاية منتهية، عمودية من نهاية $\\pm\\infty$).",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["مقاربات", "نهاية", "أفقية", "عمودية"],
  },
  {
    title: "المقاربات 2 — مقاربة مائلة بالقسمة الإقليدية",
    statement:
      "لتكن $f(x) = \\dfrac{x^2 + 2x + 1}{x + 1}$. ادرس النهايات وحدد المقاربات.",
...
`,
    methodology:
      "المقاربة تتطلب أن يؤول الرسم إلى المستقيم دون أن يقع عليه. هنا الدالة مساوية للمستقيم نفسه على $D_f$، فلا نتحدث عن مقاربة بل عن تبسيط.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["مقاربات", "قسمة إقليدية", "تبسيط"],
  },
  {
    title: "المقاربات 3 — مقاربة مائلة كاملة",
    statement:
      "لتكن $f(x) = \\dfrac{x^2 + x + 1}{x}$. أوجد المقاربات كاملة (مقاربة مائلة + موضع الرسم).",
...
`,
    methodology:
      "لإيجاد المقاربة المائلة للدوال الكسرية بدرجة بسط = درجة مقام + 1، نستعمل القسمة الإقليدية أو نكتب الدالة بشكل $ax + b + \\dfrac{r(x)}{q(x)}$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["مقاربة مائلة", "موضع الرسم", "قسمة إقليدية"],
  },
  {
    title: "المقاربات 4 — مقاربة بمعامل على x",
    statement:
      "لتكن $f(x) = \\dfrac{x^2 - 3x + 2}{x - 1}$. حدد المقاربات.",
...
`,
    methodology:
      "عندما يمكن إلغاء عامل مشترك بين البسط والمقام، الدالة تبسّط إلى دالة بسيطة، لكن تبقى فجوة عند القيمة الممنوعة (نقطة قابلة للإزالة).",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["مقاربات", "تبسيط", "فجوة"],
  },
  {
    title: "المقاربات 5 — صحيح/خطأ",
    statement:
      "هل العبارة صحيحة؟ «كل دالة كسرية لها مقاربة عمودية عند كل قيمة ممنوعة.»",
...
`,
    methodology:
      "وجود قيمة ممنوعة لا يكفي لوجود مقاربة عمودية. يجب دراسة النهاية من الجانبين.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["مقاربات", "نهاية", "صحيح/خطأ"],
  },
  {
    title: "المقاربات 6 — اختيار من متعدد",
    statement:
      "الدالة $f(x) = \\dfrac{x^2 - 2x + 3}{x - 1}$ لها مقاربة مائلة $y = ax + b$. ما قيمة $b$؟\n\nA) $1$  \nB) $-1$  \nC) $0$  \nD) $2$",
    hint: "اقسم إقليدياً.",
    solution: `
...
`,
    methodology:
      "القسمة الإقليدية طريقة مباشرة لإيجاد المقاربة المائلة للدوال الكسرية بدرجة بسط = درجة مقام + 1.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["مقاربة مائلة", "قسمة إقليدية", "اختيار من متعدد"],
  },
  {
    title: "المقاربات 7 — دالة بتركيب أسية",
    statement:
      "لتكن $f(x) = \\dfrac{e^x - 1}{e^x + 1}$. ادرس نهايات $f$ عند $\\pm\\infty$ واستنتج المقاربات.",
    hint: "اقسم على $e^x$.",
    solution: `
**1. عند $+\\infty$:**
...
`,
    methodology:
      "للدوال الأسية عند $+\\infty$ نقسم على $e^x$. عند $-\\infty$ نلاحظ أن $e^x \\to 0$ ونحسب مباشرة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["مقاربة أفقية", "أسية", "تركيب"],
  },
  {
    title: "المقاربات 8 — دالة لوغاريتم",
    statement:
      "لتكن $f(x) = x \\ln\\left(1 + \\dfrac{1}{x}\\right)$. احسب $\\lim_{x \\to +\\infty} f(x)$.",
...
`,
    methodology:
      "التعرف على النماذج المعروفة ($\\ln(1+h)/h \\to 1$, $\\sin(h)/h \\to 1$, $(e^h - 1)/h \\to 1$) يسهّل حساب النهايات.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["نهاية", "لوغاريتم", "مقاربة أفقية"],
  },
  {
    title: "المقاربات 9 — مقاربة مائلة لدالة لوغاريتمية",
    statement:
      "لتكن $f(x) = x + \\ln(x)$ على $]0, +\\infty[$. ادرس نهاياتها وحدد المقاربات.",
...
`,
    methodology:
      "ليس كل دالة لها مقاربة مائلة. شرطها: $f(x) - (ax + b) \\to 0$. هنا $f(x) - x \\to +\\infty$، فلا مقاربة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["مقاربات", "لوغاريتم", "عدم وجود مقاربة مائلة"],
  },
  {
    title: "المقاربات 10 — مقاربة لدالة معقدة",
    statement:
      "لتكن $f(x) = x - 1 + \\dfrac{e^{-x}}{x}$ على $]0, +\\infty[$. ادرس نهاياتها وحدد المقاربات.",
...
`,
    methodology:
      "حين تظهر دالة أسية وكسر، ندرس كل جزء على حدة: الأسية $e^{-x}$ تتحكم عند $+\\infty$، والقسمة على $x$ تتحكم عند $0$.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["مقاربات", "أسية", "موضع الرسم"],
  },

  // ----------------------------------------------------------
  //  القسم 3: الاشتقاق — 20 تمرين
  // ----------------------------------------------------------
  {
...
`,
    methodology:
      "قاعدة الاشتقاق $(x^n)' = n x^{n-1}$ هي القاعدة الأساسية. تُطبَّق حدًّا بحد على كثيرات الحدود.",
    difficulty: "PREREQUISITE",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["اشتقاق", "كثيرة حدود"],
  },
  {
...
`,
    methodology:
      "قاعدة الجداء $(uv)' = u'v + uv'$ تستعمل عندما يكون المنتج غير قابل للتبسيط. يمكن التحقق بالنشر أولاً.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "جداء"],
...
`,
    methodology:
      "قاعدة الكسر $\\left(\\dfrac{u}{v}\\right)' = \\dfrac{u'v - uv'}{v^2}$ أساسية. لاحظ إشارة الناقص في البسط!",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "كسر"],
...
`,
    methodology:
      "قاعدة السلسلة: $\\left(u^n\\right)' = n u^{n-1} \\cdot u'$. لا ننسى ضرب المشتقة الداخلية.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "تركيب", "قاعدة السلسلة"],
  },
  {
...
`,
    methodology:
      "اشتقاق الجذر: $(\\sqrt{u})' = \\dfrac{u'}{2\\sqrt{u}}$. لا ننسى العامل $2$ في المقام.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "جذر", "تركيب"],
  },
  {
...
`,
    methodology:
      "اشتقاق الأسية: $(e^u)' = u' \\cdot e^u$. الأسية تبقى كما هي ونضرب بمشتقة الأس.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "أسية", "تركيب"],
  },
  {
...
`,
    methodology:
      "اشتقاق اللوغاريتم: $(\\ln u)' = \\dfrac{u'}{u}$. سهل ولكنه يستلزم التمييز بين البسط والمقام.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "لوغاريتم", "تركيب"],
  },
  {
...
`,
    methodology:
      "عند ضرب دالة جبرية بدالة أسية أو لوغاريتمية، استعمال قاعدة الجداء أمر ضروري. التبسيط المباشر صعب.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["اشتقاق", "جداء", "لوغاريتم"],
  },
  {
...
`,
    methodology:
      "في الكسور، نبسّط بتحليل البسط ومقارنته بالمقام. هنا نستخرج $e^x \\cdot x$ المشترك.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["اشتقاق", "كسر", "أسية"],
  },
  {
...
`,
    methodology:
      "التبسيط بعد الاشتقاق مطلوب. هنا $\\dfrac{1}{x} \\cdot x = 1$ تبسيط مهم.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["اشتقاق", "كسر", "لوغاريتم"],
  },
  {
...
`,
    methodology:
      "عند تركيب قاعدة السلسلة مع قاعدة الجداء، نطبقهما تباعاً: أولاً نحسب مشتقة الداخل، ثم نضرب بها.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["اشتقاق", "تركيب", "جداء", "أسية"],
  },
  {
...
`,
    methodology:
      "الدالة $|x|$ تُشتق بدراسة إشارتها. التحقق عند نقطة التحول (0) بتعريف المشتقة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["اشتقاق", "قيمة مطلقة", "تعريف المشتقة"],
  },
  {
...
`,
    methodology:
      "المشتقة الثانية تُستعمل لدراسة التقعر والمحدبة. نحسبها باشتقاق المشتقة الأولى.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["اشتقاق", "مشتقة ثانية", "تقعر"],
  },
  {
...
`,
    methodology:
      "الاشتقاق اللوغاريتمي طريقة قوية للدوال المنتجة جدًا (جداء وكسور مركبة). نطبق $\\ln$ ثم نشق.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["اشتقاق", "لوغاريتم", "تبسيط"],
  },
  {
...
`,
    methodology:
      "دالة الأساس $1/x$ تُشتق بـ $-1/x^2$. الانتباه للإشارة السالبة دائماً.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["اشتقاق", "أسية", "كسر"],
  },
  {
...
`,
    methodology:
      "تركيب عدة قواعد: نبدأ من الخارج (الجذر) ثم نطبق على الداخل (الأسية).",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["اشتقاق", "تركيب", "جذر", "أسية"],
  },
  {
...
`,
    methodology:
      "$f'(x_0) = 0$ شرط لازم وليس كافٍ. يجب التحقق من تغيّر إشارة المشتقة أو دراسة المشتقة الثانية.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 3,
    tags: ["اشتقاق", "قيمة قصوى", "صحيح/خطأ"],
  },
  {
...
`,
    methodology:
      "التبسيط قبل الاشتقاق يجعل الحساب أسهل، لكن يجب التأكد من الحفاظ على نفس مجال التعريف.",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 5,
    tags: ["اشتقاق", "برهان", "لوغاريتم", "تبسيط"],
  },
  {
...
`,
    methodology:
      "في الأسئلة ذات الإجابات المتكافئة جبرياً، نختار إجابة «متكافئ» بعد التحقق. التعبير المُستخرج عامل مشترك يكون أنظف.",
    difficulty: "ADVANCED",
    type: "MULTIPLE_CHOICE",
    points: 4,
    tags: ["اشتقاق", "جداء", "اختيار من متعدد"],
  },
  {
...
`,
    methodology:
      "البرهان بالتراجع مناسبة للخصائص التي تعتمد على عدد طبيعي. الترتيب: أساس + فرضية تراجعية + إثبات الخطوة الموالية.",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 6,
    tags: ["اشتقاق", "برهان", "تراجع"],
  },

  // ----------------------------------------------------------
  //  القسم 4: إشارة المشتقة وجدول التغيرات — 15 تمرين
  // ----------------------------------------------------------
  {
...
`,
    methodology:
      "الترتيب: اشتق → حل $f'(x) = 0$ → ادرس إشارة $f'$ → ارسم الجدول → عوّض في $f$ لإيجاد القيم القصوى.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["إشارة المشتقة", "جدول تغيرات", "تربيعية"],
  },
  {
...
`,
    methodology:
      "للدالة التكعيبية، المشتقة تربيعية قد يكون لها 0 أو 1 أو 2 جذراً. حل التحليل ثم دراسة الإشارة بمخطط.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["إشارة المشتقة", "جدول تغيرات", "تكعيبية"],
  },
  {
...
`,
    methodology:
      "للدوال الكسرية، حل $f' = 0$ بمساواة البسط بالصفر (المقام موجب). نهايات $f$ عند $\\pm\\infty$ تساعد على رسم الجدول.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "جدول تغيرات", "كسرية"],
  },
  {
...
`,
    methodology:
      "للدوال على مجال محدود، ندرس النهايات عند فروع المجال لمعرفة كيف يدخل ويخرج الرسم.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["إشارة المشتقة", "جدول تغيرات", "لوغاريتم"],
  },
  {
...
`,
    methodology:
      "للدوال الأسية عند $+\\infty$ الأسية تتفوق على القدرات. عند $-\\infty$ الأسية $e^{-x}$ تصبح كبيرة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "جدول تغيرات", "أسية"],
  },
  {
...
`,
    methodology:
      "القدرة الكسرية $x^{a/b}$ تُشتق بـ $\\dfrac{a}{b} x^{(a-b)/b}$، أسهل من تطبيق قاعدة الجداء مباشرة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["إشارة المشتقة", "جدول تغيرات", "جذر", "قدرة كسرية"],
  },
  {
...
`,
    methodology:
      "في الاشتقاق، استخراج العامل المشترك في البسط يبسّط دراسة الإشارة بشكل كبير.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["إشارة المشتقة", "جدول تغيرات", "كسرية", "تحليل"],
  },
  {
...
`,
    methodology:
      "هذه الدالة $\\dfrac{\\ln x}{x}$ كلاسيكية في البكالوريا. لها أقصى عند $x = e$ قيمته $1/e$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "جدول تغيرات", "لوغاريتم", "دالة كلاسيكية"],
  },
  {
...
`,
    methodology:
      "الفرق بين تزايدية (croissante) وتزايدية قطعية (strictement croissante) يأتي من إشارة $f'$: $\\geq 0$ مقابل $> 0$.",
    difficulty: "ADVANCED",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["إشارة المشتقة", "تزايد قطعي", "صحيح/خطأ"],
  },
  {
...
`,
    methodology:
      "في جدول التغيرات مع قيمة ممنوعة نضع عمودين مزدوجين ($\\Vert$) للقيمة الممنوعة ونفصل التغيرات.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "جدول تغيرات", "قيمة ممنوعة", "مقاربة"],
  },
  {
...
`,
    methodology:
      "عند وجود عدة جذور للمشتقة، نستعمل مخطط الإشارات لتحديد إشارة $f'$ في كل مجال.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "جدول تغيرات", "مخطط إشارات"],
  },
  {
...
`,
    methodology:
      "العلاقة $f' = g$ تربط تغيرات $f$ بإشارة $g$. نحسب $f$ بالتكامل ثم نُعيّن الثابت بشرط أولي.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["إشارة المشتقة", "دالة أصلية", "تكامل"],
  },
  {
...
`,
    methodology:
      "كل جذر للمشتقة يقابله تغيّر إشارة يعطي قيمة قصوى أو صغرى محلية. بدون تغيّر إشارة لا توجد قيمة قصوى/صغرى.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 4,
    tags: ["إشارة المشتقة", "قيمة قصوى", "اختيار من متعدد"],
  },
  {
...
`,
    methodology:
      "عند انعدام المشتقة دون تغيير إشارة، الرسم يمر بنقطة انعطاف أفقية (مثل $x^3$ عند 0). لا قيمة قصوى في هذه الحالة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["إشارة المشتقة", "مشتقة ثانية", "نقطة انعطاف"],
  },
  {
...
`,
    methodology:
      "نظرية القيم المتوسطة هي الأداة المركزية لربط المشتقة بالتغيرات. بدونها لا يمكن برهان علاقات الرتابة.",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 6,
    tags: ["إشارة المشتقة", "برهان", "نظرية القيم المتوسطة", "رتابة"],
  },

  // ----------------------------------------------------------
  //  القسم 5: التقابل — 10 تمارين
  // ----------------------------------------------------------
  {
...
`,
    methodology:
      "شرط التقابل على مجال $I$: الدالة متصلة ورتيبة قطعاً على $I$. نستعمل المشتقة لإثبات الرتابة.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["تقابل", "رتابة", "تربيعية"],
  },
  {
...
`,
    methodology:
      "تقابل الدالة $\\iff$ رتيبة قطعاً + متصلة + $f(I)$ محدد. الأسية واللوغاريتم مثالان كلاسيكيان لدالتين عكسيتين.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["تقابل", "أسية", "لوغاريتم", "دالة عكسية"],
  },
  {
...
`,
    methodology:
      "انعدام المشتقة في نقاط معزولة لا يلغي التزايد القطعي. شرط التزايد القطعي الكافي: $f' \\geq 0$ و $f'$ لا تنعدم إلا في نقاط معزولة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["تقابل", "تكعيبية", "نقطة معزولة"],
  },
  {
...
`,
    methodology:
      "الدالة غير الرتيبة على $\\mathbb{R}$ يمكن أن تكون تقابلاً على كل نصف مجال رتيبة فيه. نقطة انعدام المشتقة هي الحد بين النصفين.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["تقابل", "تربيعية", "دالة عكسية"],
  },
  {
...
`,
    methodology:
      "تقابل الدالة يضمن وحدة الحل. لإثبات وحدة الحل نثبت أن الدالة رتيبة قطعاً. للحل العددي نحاول قيماً صحيحة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["تقابل", "حل معادلة", "وحدة الحل"],
  },
  {
...
`,
    methodology:
      "شرط التقابل: رتيبة قطعاً + متصلة على مجال متصل. إذا كان المجال غير متصل، ندرس كل مكوّن على حدة.",
    difficulty: "ADVANCED",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["تقابل", "صحيح/خطأ", "استمرارية"],
  },
  {
...
`,
    methodology:
      "النهايات عند فروع المجال تحدد المجال المستقر. للوغاريتم: $]0, +\\infty[ \\to \\mathbb{R}$.",
    difficulty: "BEGINNER",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["تقابل", "لوغاريتم", "أسية"],
  },
  {
...
`,
    methodology:
      "لحل معادلة من النوع $f(x) = 0$، ندرس $f$ كاملة (رتابة، قيم قصوى) ثم نطبق نظرية القيمة المتوسطة على كل مجال رتيب.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["تقابل", "TVI", "حل معادلة", "تكعيبية"],
  },
  {
...
`,
    methodology:
      "بعض الدوال هي عكسية لنفسها (involutive). التحقق بحساب $f(f(x))$ يعطي $x$ دائماً.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["تقابل", "كسرية", "دالة عكسية", "دالة عكسية لنفسها"],
  },
  {
...
`,
    methodology:
      "تقابل الدالة على مجال متصل يأتي من: رتيبة قطعاً (للحقن) + متصلة (للعبرة عبر نظرية القيمة المتوسطة).",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 7,
    tags: ["تقابل", "برهان", "حقن", "عبرة"],
  },

  // ----------------------------------------------------------
  //  القسم 6: التقعر والمحدبة — 10 تمارين
  // ----------------------------------------------------------
  {
...
`,
    methodology:
      "إشارة المشتقة الثانية تحدد التقعر: $f'' > 0$ → محدّبة، $f'' < 0$ → مقعّرة. تغيّر الإشارة يعطي نقطة انعطاف.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["تقعر", "محدبة", "مشتقة ثانية"],
  },
  {
...
`,
    methodology:
      "نقطة الانعطاف: $f''(x_0) = 0$ **و** تغيّر إشارة $f''$ قبل وبعد $x_0$. الشرطان معاً مطلوبان.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["تقعر", "نقطة انعطاف", "تكعيبية"],
  },
  {
...
`,
    methodology:
      "الدالة الأسية محدّبة دائماً على $\\mathbb{R}$. الرسم ينعطف للأعلى باستمرار، وهذا يتجلى في نموها المتسارع.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["تقعر", "أسية", "محدبة"],
  },
  {
...
`,
    methodology:
      "نقطة الانعطاف تتطلب أن تكون $x_0$ في مجال $D_f$. القيمة الممنوعة لا تُعتبر نقطة انعطاف حتى لو تغيّرت إشارة $f''$ عندها.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["تقعر", "كسرية", "قيمة ممنوعة"],
  },
  {
...
`,
    methodology:
      "شرط نقطة الانعطاف: $f''(x_0) = 0$ **و** تغيّر إشارة $f''$ عبر $x_0$. انعدام $f''$ دون تغيّر إشارة لا يعطي نقطة انعطاف.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["تقعر", "نقطة انعطاف", "محدبة"],
  },
  {
...
`,
    methodology:
      "انعدام $f''$ شرط لازم وليس كافٍ لنقطة الانعطاف. لا بد من التحقق من تغيّر الإشارة.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["تقعر", "نقطة انعطاف", "صحيح/خطأ"],
  },
  {
...
`,
    methodology:
      "للدالة التكعيبية $ax^3 + bx^2 + cx + d$، نقطة الانعطاف عند $x = -b/(3a)$. هنا $b = 0$ و $a = 1$، إذن $x = 0$.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["تقعر", "اختيار من متعدد", "تكعيبية"],
  },
  {
...
**التطبيق:** متباينة كوشي-شفارتس ومتباينة ينسن تأتيان من هذا التعريف.`,
    methodology:
      "المتباينة الواردة هي **تعريف** المحدّبية نفسها. البرهان هندسي: الرسم المحدّب تحت وتره. متباينة ينسن تعميم لهذه المتباينة.",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 7,
    tags: ["تقعر", "برهان", "محدّبة", "متباينة ينسن"],
  },

  // ----------------------------------------------------------
  //  القسم 7: دراسات شاملة (PROBLEM) — 5 تمارين بكالوريا
  // ----------------------------------------------------------
  {
    title: "دراسة شاملة 1 — دالة كسرية بمقاربة مائلة",
    statement:
      "لتكن $f(x) = \\dfrac{x^2 - 3x + 2}{x - 1}$ على $D_f = \\mathbb{R} \\setminus \\{1\\}$.\n\n1. ادرس نهايات $f$ عند فروع المجال.\n2. برهن أن $f(x) = x - 2$ لكل $x \\neq 1$ واستنتج المقاربات.\n3. اشتق $f$ على $D_f$ وادرس إشارتها.\n4. هل $f$ تقابل على $]1, +\\infty[$؟ علّل.",
...
`,
    methodology:
      "في هذه الدراسة، التبسيط يكشف أن الدالة تماثل خطاً مستقيماً مع فجوة. هذا الحالة يجب التمييز فيها بين المقاربة والتماثل، وبين القيمة الممنوعة ونقطة الفجوة.",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 12,
    tags: ["دراسة شاملة", "تبسيط", "فجوة", "تقابل"],
  },
  {
    title: "دراسة شاملة 2 — دالة لوغاريتمية",
    statement:
      "لتكن $f(x) = x \\ln(x) - x$ على $]0, +\\infty[$.\n\n1. ادرس نهايات $f$ عند $0^+$ و $+\\infty$.\n2. اشتق $f$ وادرس إشارتها.\n3. ارسم جدول التغيرات.\n4. ما طبيعة النقطة الحرجة؟",
...
`,
    methodology:
      "النهاية $\\lim_{x \\to 0^+} x \\ln(x) = 0$ كلاسيكية في البكالوريا. للتحقق من طبيعة القطب نستعمل $f''$ أو تغيّر إشارة $f'$.",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 12,
    tags: ["دراسة شاملة", "لوغاريتم", "نهاية", "محدّبة"],
  },
  {
    title: "دراسة شاملة 3 — دالة أسية وجداء",
    statement:
      "لتكن $f(x) = (x^2 - 2x) e^{-x}$ على $\\mathbb{R}$.\n\n1. ادرس نهايات $f$ عند $\\pm\\infty$.\n2. احسب $f'(x)$ وادرس إشارتها.\n3. ارسم جدول التغيرات.\n4. ادرس تقعر $f$.",
...
`,
    methodology:
      "الزوجية/الفردية تبسّط الدراسة: ندرس على نصف المجال ثم نستنتج على الآخر بالتماثل. الفردية: $f(-x) = -f(x)$.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 15,
    tags: ["دراسة شاملة", "جذر", "كسرية", "زوجية", "تقابل", "بكالوريا"],
  },
  {
    title: "دراسة شاملة 5 — دالة بمعاملين وتركيب معقد",
    statement:
      "لتكن $f(x) = \\dfrac{x e^x}{x + 1}$ على $D_f = \\mathbb{R} \\setminus \\{-1\\}$.\n\n1. ادرس نهايات $f$ عند $\\pm\\infty$ وعند $x = -1$.\n2. اشتق $f$ وادرس إشارتها على $D_f$.\n3. ارسم جدول التغيرات.\n4. ادرس موضع الرسم بالنسبة لمقاربته الأفقية.",
...
`,
    methodology:
      "في الدراسات الشاملة للبكالوريا، أهم النقاط: الاشتقاق بتركيب عدة قواعد، إشارة المشتقة بمخطط متعدد العوامل، وموضع الرسم بالنسبة للمقاربات.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 16,
    tags: ["دراسة شاملة", "أسية", "كسرية", "مقاربة أفقية", "موضع الرسم", "بكالوريا"],
  },
];
...
//  الفصل الثاني: الدوال ذات المعامل + الأمثلية (100 تمرين)
// ============================================================
export const bankFunctionsChapter2: ExerciseSeed[] = [
  // ----------------------------------------------------------
  //  القسم 1: أساسيات الدالة بمعامل — 15 تمرين
  // ----------------------------------------------------------
  {
    title: "معامل 1 — تحديد القيم الحرجة",
    statement:
      "لتكن $f_m(x) = x^2 + m x + 1$ مع $m \\in \\mathbb{R}$. حدد قيم $m$ التي تجعل مميز $f_m'$ يغير إشارته.",
...
`,
    methodology:
      "في الدوال التربيعية بمعامل، $f_m'$ خطية دائماً والجذر وحيد. القيمة الحرجة تظهر عند دراسة المميز لو كانت درجة أعلى.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["معامل", "قيمة حرجة", "تربيعية"],
  },
  {
    title: "معامل 2 — دراسة مميز تربيعي",
    statement:
      "لتكن $f_m(x) = x^2 + 2mx + m$. ادرس مميز المعادلة $f_m(x) = 0$ حسب $m$.",
...
`,
    methodology:
      "للتربيعية بمعامل، ندرس إشارة المميز $\\Delta(m)$ حسب $m$. القيم الحرجة هي جذور $\\Delta(m) = 0$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "مميز", "مناقشة"],
  },
  {
    title: "معامل 3 — مناقشة عدد النقاط الثابتة",
    statement:
      "لتكن $f_m(x) = x^2 - m x + 4$. ناقش حسب $m$ عدد نقاط تقاطع الرسم مع المحور الأفقي.",
...
`,
    methodology:
      "نقاط تقاطع الرسم مع المحور الأفقي = حلول $f_m(x) = 0$. ندرس المميز حسب $m$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["معامل", "تقاطع", "مميز"],
  },
  {
    title: "معامل 4 — تأثير m على القيمة الصغرى",
    statement:
      "لتكن $f_m(x) = x^2 - 2mx + m^2$. احسب القيمة الصغرى لـ $f_m$ بدلالة $m$.",
...
`,
    methodology:
      "التربيعية $x^2 - 2mx + m^2 = (x-m)^2$ لها قيمة صغرى = 0 مهما كان $m$. الموقع يتغير لكن القيمة لا.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["معامل", "قيمة صغرى", "تربيعية"],
  },
  {
    title: "معامل 5 — مناقشة مجال تعريف بمعامل",
    statement:
      "لتكن $f_m(x) = \\sqrt{x - m}$. ما مجال تعريف $f_m$ بدلالة $m$؟",
    hint: "حل $x - m \\geq 0$.",
    solution: `
...
`,
    methodology:
      "للدوال بمعامل، المجال قد يعتمد على $m$. نقوم بمناقشة صريحة لكيفية تغيّر المجال حسب $m$.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 2,
    tags: ["معامل", "مجال التعريف", "جذر"],
  },
  {
    title: "معامل 6 — مناقشة نهاية بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x - m}{x + m}$ (مع $m \\neq 0$). ادرس نهاية $f_m$ عند $\\pm\\infty$ وعند $x = -m$.",
...
`,
    methodology:
      "النهاية عند القيمة الممنوعة $x = -m$ تعتمد على إشارة $m$. يجب مناقشة كل حالة على حدة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "نهاية", "مقاربة", "مناقشة"],
  },
  {
    title: "معامل 7 — تأثير m على الرتابة",
    statement:
      "لتكن $f_m(x) = x^3 - m x$ على $\\mathbb{R}$. ناقش حسب $m$ عدد النقاط الحرجة لـ $f_m$.",
...
`,
    methodology:
      "عند مناقشة عدد النقاط الحرجة، نحل $f_m'(x) = 0$ حسب $m$. القيم الحرجة لـ $m$ تأتي من تغيّر عدد الحلول.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "نقاط حرجة", "مناقشة", "تكعيبية"],
  },
  {
    title: "معامل 8 — مقاربة مائلة بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 + m x + 1}{x}$ على $\\mathbb{R}^*$. ادرس المقاربات بدلالة $m$.",
...
`,
    methodology:
      "في المقاربات المائلة بمعامل، المعامل يظهر في حاصل القسمة ($y = x + m$) لكن موضع الرسم قد يكون مستقلاً عن $m$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "مقاربة مائلة", "موضع الرسم"],
  },
  {
    title: "معامل 9 — تأثير m على التقابل",
    statement:
      "لتكن $f_m(x) = x^2 + m x$ على $\\mathbb{R}$. على أي مجال $f_m$ تقابل بدلالة $m$؟",
...
`,
    methodology:
      "في التقابل بمعامل، موضع القيمة الحرجة ونطاق التقابل يتغيران حسب $m$. المناقشة تتطلب حساباً صريحاً.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "تقابل", "رتابة"],
  },
  {
    title: "معامل 10 — دالة أسية بمعامل",
    statement:
      "لتكن $f_m(x) = e^{mx}$. ادرس رتابة $f_m$ حسب $m$.",
...
`,
    methodology:
      "للأسية بمعامل $e^{mx}$، الرتابة تعتمد على إشارة $m$. التحويل من تزايد إلى ثابت إلى تناقص يعكس انتقال $m$ من موجب إلى معدوم إلى سالب.",
    difficulty: "BEGINNER",
    type: "DIRECT_APPLICATION",
    points: 3,
    tags: ["معامل", "أسية", "رتابة"],
  },
  {
    title: "معامل 11 — دالة لوغاريتمية بمعامل",
    statement:
      "لتكن $f_m(x) = \\ln(mx + 1)$ مع $m \\neq 0$. ناقش حسب $m$ مجال تعريف $f_m$.",
    hint: "حل $mx + 1 > 0$.",
    solution: `
...
`,
    methodology:
      "عند حل متراجحة بمعامل، يجب الانتباه لإشارة المعامل: التقسيم على $m$ سالب ينعكس الإشارة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 4,
    tags: ["معامل", "لوغاريتم", "مجال التعريف", "متراجحة"],
  },
  {
    title: "معامل 12 — صحيح/خطأ",
    statement:
      "هل العبارة صحيحة؟ «إذا كان $\\Delta(m) > 0$ فإن المعادلة $f_m(x) = 0$ لها حلّان حقيقيان دائماً.»",
...
`,
    methodology:
      "المميز مفهوم يخص المعادلات التربيعية. تعميمه على درجات أعلى يتطلب أدوات أخرى (مثل دراسة الرتابة + TVI).",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 3,
    tags: ["معامل", "مميز", "صحيح/خطأ"],
  },
  {
    title: "معامل 13 — دالة كسرية بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x - m}{x^2 + 1}$. ناقش حسب $m$ موقع أقصى محلي لـ $f_m$.",
    hint: "حلل $f_m'$.",
    solution: `
...
`,
    methodology:
      "بعض الدوال بمعامل لها دائماً نفس العدد من النقاط الحرجة (مثل هذه) لكن موقعها يتبدل حسب $m$.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "نقطة حرجة", "كسرية", "أقصى محلي"],
  },
  {
    title: "معامل 14 — اختيار من متعدد",
    statement:
      "لتكن $f_m(x) = x^2 - 4x + m$. القيمة الصغرى لـ $f_m$ تساوي:\n\nA) $m$  \nB) $m - 4$  \nC) $m + 4$  \nD) $m - 16$",
...
`,
    methodology:
      "القيمة الصغرى للتربيعية $ax^2 + bx + c$ عند $x = -b/(2a)$ وقيمتها $c - b^2/(4a)$.",
    difficulty: "BEGINNER",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["معامل", "قيمة صغرى", "اختيار من متعدد"],
  },
  {
    title: "معامل 15 — برهان خاصية عامة",
    statement:
      "برهن أن الدالة $f_m(x) = x^2 + 2mx + m^2$ تزايدية قطعاً على $[-m, +\\infty[$ لكل $m \\in \\mathbb{R}$.",
...
`,
    methodology:
      "إذا كان $f'(x) \\geq 0$ على مجال وتنعدم فقط في نقطة معزولة، فإن $f$ تزايدية قطعاً على المجال.",
    difficulty: "INTERMEDIATE",
    type: "DEMONSTRATION",
    points: 5,
    tags: ["معامل", "برهان", "رتابة"],
  },

  // ----------------------------------------------------------
  //  القسم 2: مناقشة حسب m — اشتقاق وتغيرات — 20 تمرين
  // ----------------------------------------------------------
  {
    title: "معامل 16 — مناقشة المميز في الاشتقاق",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 - m}{x - 1}$ على $D = \\mathbb{R} \\setminus \\{1\\}$. ناقش حسب $m$ عدد القيم الحرجة لـ $f_m$.",
    hint: "حلل البسط بعد الاشتقاق.",
    solution: `
...
`,
    methodology:
      "في مناقشة المميز، يجب التحقق أن الجذور داخل المجال. الجذر المزدوج في $x = 1$ لا يُحتسب إذا كانت 1 قيمة ممنوعة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 7,
    tags: ["معامل", "مميز", "اشتقاق", "مناقشة", "كسرية"],
  },
  {
    title: "معامل 17 — حالات ثلاثة لمناقشة",
    statement:
      "لتكن $f_m(x) = x^3 - 3mx + 2$. ناقش حسب $m$ عدد القيم القصوى/الصغرى المحلية.",
...
`,
    methodology:
      "في المناقشة بمعامل، القيمة الحرجة تأتي من تغيّر عدد جذور المعادلة $f_m'(x) = 0$. هنا $m = 0$ هي القيمة الحرجة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 7,
    tags: ["معامل", "مناقشة", "قيم قصوى", "تكعيبية"],
  },
  {
    title: "معامل 18 — مقاربة مائلة بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 + 2mx + 3}{x - m}$. ادرس المقاربة المائلة بدلالة $m$.",
    hint: "اقسم إقليدياً.",
    solution: `
...
`,
    methodology:
      "في القسمة الإقليدية بمعامل، نكتب $P(x) = Q(x) \\cdot D(x) + R(x)$ مع $R$ من الدرجة الأقل. المقاربة المائلة $y = D(x)$.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "مقاربة مائلة", "قسمة إقليدية", "موضع الرسم"],
  },
  {
    title: "معامل 19 — مناقشة تزايد/تناقص",
    statement:
      "لتكن $f_m(x) = m x^2 + 2x - 1$. ناقش حسب $m$ رتابة $f_m$.",
...
`,
    methodology:
      "في المناقشة بمعامل، يجب فصل الحالات حسب إشارة $m$ (موجب/معدوم/سالب)، لأن القسمة على $m$ تنعكس الإشارة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "مناقشة", "رتابة", "إشارة"],
  },
  {
    title: "معامل 20 — صحيح/خطأ",
    statement:
      "هل العبارة صحيحة؟ «إذا كان $m$ كافٍ كبيراً فإن $f_m(x) = x^2 + m$ ليس لها جذور حقيقية.»",
    hint: "حل $x^2 + m = 0$.",
    solution: `
...
`,
    methodology:
      "في الصحيح/خطأ، يجب قراءة العبارة بدقة: «كافٍ كبير» قد تعني موجباً وLarge. تحديد المعنى مهم.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 3,
    tags: ["معامل", "صحيح/خطأ", "جذور"],
  },
  {
    title: "معامل 21 — اختيار من متعدد بمعامل",
    statement:
      "لتكن $f_m(x) = x^2 + mx + 1$. لأي قيمة $m$ تكون $f_m$ غير سالبة على $\\mathbb{R}$؟\n\nA) $m \\in [-2, 2]$  \nB) $m \\in [-1, 1]$  \nC) $m \\in (-\\infty, 2]$  \nD) $m \\in \\mathbb{R}$",
    hint: "ادرس المميز.",
    solution: `
...
`,
    methodology:
      "للتربيعية $ax^2 + bx + c$ (مع $a > 0$): $\\geq 0$ على $\\mathbb{R}$ $\\iff$ $\\Delta \\leq 0$.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["معامل", "اختيار من متعدد", "تربيعية", "مميز"],
  },
  {
    title: "معامل 22 — مناقشة تقابل بمعامل",
    statement:
      "لتكن $f_m(x) = x^3 + m x$. ناقش حسب $m$ تقابل $f_m$ على $\\mathbb{R}$.",
    hint: "ادرس رتابة $f_m$.",
    solution: `
$f_m'(x) = 3x^2 + m$.
...
`,
    methodology:
      "في تقابل الدالة بمعامل، القيمة الحرجة تأتي من تغيّر إشارة $f_m'$ (الرتابة). $m = 0$ قيمة حرجة هنا.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "تقابل", "رتابة", "مناقشة"],
  },
  {
    title: "معامل 23 — تأثير m على تقعر دالة تكعيبية",
    statement:
      "لتكن $f_m(x) = x^3 + m x^2$. ناقش حسب $m$ نقطة الانعطاف.",
    hint: "حل $f_m''(x) = 0$.",
    solution: `
$f_m'(x) = 3x^2 + 2mx$.
...
`,
    methodology:
      "للدالة التكعيبية $ax^3 + bx^2 + cx + d$، نقطة الانعطاف دائماً عند $x = -b/(3a)$. بمعامل، الموقع يتغير حسب $m$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "نقطة انعطاف", "تقعر", "تكعيبية"],
  },
  {
    title: "معامل 24 — صحيح/خطأ: تأثير m على التقابل",
    statement:
      "هل العبارة صحيحة؟ «إذا كان $m > 0$ فإن $f_m(x) = x^3 + m x$ تقابل على $\\mathbb{R}$.»",
    hint: "ادرس رتابة $f_m$.",
    solution: `
$f_m'(x) = 3x^2 + m$.
...
`,
    methodology:
      "إذا $f'$ موجبة تماماً على $\\mathbb{R}$ (وليس فقط $\\geq 0$) فهذا يضمن التزايد القطعي، ومن ثم التقابل على $\\mathbb{R}$.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["معامل", "تقابل", "صحيح/خطأ"],
  },
  {
    title: "معامل 25 — دالة كسرية معقدة بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 - 1}{x - m}$. ناقش حسب $m$ قيم ممنوعة للدالة.",
    hint: "حل $x - m = 0$.",
    solution: `
المقام $x - m \\neq 0 \\implies x \\neq m$.
...
`,
    methodology:
      "عند تساوي البسط والمقام في الانعدام، تظهر فجوة (نقطة قابلة للإزالة) بدل مقاربة عمودية. مناقشة ضرورية.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "قيمة ممنوعة", "فجوة", "مقاربة", "مناقشة"],
  },
  {
    title: "معامل 26 — دالة أسية بمعامل في الأس",
    statement:
      "لتكن $f_m(x) = e^{mx^2}$. ناقش حسب $m$ رتابة $f_m$.",
...
`,
    methodology:
      "الأسية بمعامل في الأس $e^{mx^2}$ لها رتابة تعتمد على إشارة $m$. عند $m = 0$ تتحول إلى ثابتة. عند $m > 0$ لها قيمة صغرى، عند $m < 0$ قيمة قصوى.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "أسية", "رتابة", "مناقشة"],
  },
  {
    title: "معامل 27 — تأثير m على لوغاريتم مركّب",
    statement:
      "لتكن $f_m(x) = \\ln(x^2 + m)$. ناقش حسب $m$ مجال تعريف $f_m$.",
    hint: "حل $x^2 + m > 0$.",
    solution: `
...
`,
    methodology:
      "في المناقشة، نتتبع القيم الحرجة لـ $m$: 0 هنا هي قيمة حرجة لأنها تغيّر طبيعة المجال من كامل إلى ثقب في المنتصف إلى مجالين منفصلين.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "مجال التعريف", "لوغاريتم", "مناقشة"],
  },
  {
    title: "معامل 28 — أقصى محلي بدلالة m",
    statement:
      "لتكن $f_m(x) = x + \\dfrac{m}{x}$ على $\\mathbb{R}^*$ (مع $m > 0$). ادرس تغيرات $f_m$.",
    hint: "حلل $f_m'$.",
    solution: `
...
`,
    methodology:
      "الدالة $f_m(x) = x + m/x$ كلاسيكية. لـ $m > 0$ لها قيمة صغرى $2\\sqrt{m}$ وأقصى $-2\\sqrt{m}$. متباينة AM-GM مرتبطة بها.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "أقصى محلي", "كسرية", "متباينة AM-GM"],
  },
  {
    title: "معامل 29 — اختيار من متعدد: قيمة صغرى بدلالة m",
    statement:
      "لتكن $f_m(x) = x^2 - 4x + m^2$. القيمة الصغرى المطلقة لـ $f_m$ تساوي:\n\nA) $m^2$  \nB) $m^2 - 4$  \nC) $m^2 + 4$  \nD) $m^2 - 16$",
    hint: "حل $f_m'(x) = 0$.",
    solution: `
$f_m'(x) = 2x - 4 = 0 \\implies x = 2$.
...
`,
    methodology:
      "القيمة الصغرى للتربيعية $ax^2 + bx + c$ تساوي $c - b^2/(4a)$. هنا $m^2 - 4$.",
    difficulty: "BEGINNER",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["معامل", "قيمة صغرى", "اختيار من متعدد"],
  },
  {
    ...
    statement:
      "برهن أن $f_m(x) = x^2 + mx$ لها قيمة صغرى دائماً مهما كان $m$، وحدد هذه القيمة.",
    hint: "حل $f_m'(x) = 0$ ثم عوّض.",
    solution: `
$f_m'(x) = 2x + m = 0 \\implies x = -m/2$.
...
`,
    methodology:
      "التربيعية $ax^2 + bx + c$ (مع $a > 0$) دائماً لها قيمة صغرى مطلقة، مهما كانت قيم $b$ و $c$ (أو $m$ هنا).",
    difficulty: "INTERMEDIATE",
    type: "DEMONSTRATION",
    points: 5,
    tags: ["معامل", "قيمة صغرى", "برهان", "تربيعية"],
  },
  {
    title: "معامل 31 — مناقشة أعمق: ثلاث حالات",
    statement:
      "لتكن $f_m(x) = \\dfrac{x - 1}{x^2 - m}$. ناقش حسب $m$ مجال تعريف $f_m$ وقيمها الممنوعة.",
    hint: "حل $x^2 - m \\neq 0$.",
    solution: `
...
`,
    methodology:
      "في مناقشة المجال بمعامل، قد يتبدل عدد القيم الممنوعة. القيم الحرجة لـ $m$ تحدد انتقالات الطبيعة.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "مجال التعريف", "مناقشة", "قيمة ممنوعة"],
  },
  {
    title: "معامل 32 — دالة كسرية بتركيب معامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 + m}{x^2 - 1}$. ناقش حسب $m$ مقاربات $f_m$.",
...
`,
    methodology:
      "إذا كان $m$ يحوّل البسط إلى قابل للقسمة على المقام (إلغاء العامل المشترك)، تختفي المقاربة العمودية وتظهر فجوة.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "مقاربات", "فجوة", "مناقشة"],
  },
  {
    title: "معامل 33 — صحيح/خطأ حول تقابل الدالة الكسرية",
    statement:
      "هل العبارة صحيحة؟ «إذا كانت $f_m(x) = \\dfrac{x^2 - m}{x}$ على $\\mathbb{R}^*$ فإن $f_m$ تقابل على $]0, +\\infty[$ لكل $m$.»",
...
`,
    methodology:
      "في مناقشة التقابل بمعامل، قد توجد قيم حرجة لـ $m$ تفصل فيها الرتابة. $m = 0$ قيمة حرجة هنا.",
    difficulty: "ADVANCED",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["معامل", "تقابل", "صحيح/خطأ", "مناقشة"],
  },
  {
    title: "معامل 34 — تأثير m على نقطة الانعطاف",
    statement:
      "لتكن $f_m(x) = x^3 - 3x^2 + m x$. ادرس كيفية تأثير $m$ على موقع نقطة الانعطاف.",
    hint: "حل $f_m''(x) = 0$.",
    solution: `
$f_m'(x) = 3x^2 - 6x + m$.
...
`,
    methodology:
      "إذا كان $m$ يضيف حدًّا خطيًّا فقط، فإن $f_m''$ لا تعتمد على $m$، وبالتالي موقع الأفصول لنقطة الانعطاف ثابت.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "نقطة انعطاف", "تقعر", "تكعيبية"],
  },
  {
    ...
    statement:
      "لتكن $f_m(x) = \\dfrac{x - 1}{x + m}$ على $]-1, +\\infty[$ (مع $m > 0$). ادرس تقابل $f_m$ وحدد دالتها العكسية.",
...
`,
    methodology:
      "للدالة الكسرية $\\dfrac{ax + b}{cx + d}$، التقابل يتطلب $ad - bc \\neq 0$. هنا $a \\cdot m - (-1) \\cdot 1 = m + 1 \\neq 0$ (مفروض $m > 0$).",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "تقابل", "دالة عكسية", "كسرية"],
  },

  // ----------------------------------------------------------
  //  القسم 3: مناقشة حسب m — تقابل وتقعر — 15 تمرين
  // ----------------------------------------------------------
  {
    title: "معامل 36 — مناقشة تقابل دالة تكعيبية",
    statement:
      "لتكن $f_m(x) = x^3 - 3x + m$. ناقش حسب $m$ عدد حلول المعادلة $f_m(x) = 0$.",
...
`,
    methodology:
      "لحل $f_m(x) = 0$ بمعامل، ندرس جدول التغيرات ثم نناقش موقع الأقصى والأدنى المحليين بالنسبة لـ 0. القيم الحرجة $m = \\pm 2$ تأتي من القطبين = 0.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 7,
    tags: ["معامل", "حل معادلة", "مناقشة", "تكعيبية", "TVI"],
  },
  {
    title: "معامل 37 — مناقشة تقعر دالة أسية",
    statement:
      "لتكن $f_m(x) = e^{x^2 + m}$. ناقش حسب $m$ تقعر $f_m$.",
    hint: "احسب $f_m''$.",
    solution: `
$f_m(x) = e^{x^2 + m}$.
...
`,
    methodology:
      "عندما يظهر $m$ في الأس بشكل خطي ($e^{x^2 + m} = e^m \\cdot e^{x^2}$)، يكافئ ضرب الدالة في ثابت موجب. لا يؤثر على إشارة المشتقة الثانية.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "تقعر", "أسية", "محدّبة"],
  },
  {
    title: "معامل 38 — مناقشة نقطة انعطاف بمعامل",
    statement:
      "لتكن $f_m(x) = x^3 - m x^2 + x$. ناقش حسب $m$ نقطة الانعطاف لـ $f_m$.",
    hint: "حل $f_m''(x) = 0$.",
    solution: `
$f_m'(x) = 3x^2 - 2mx + 1$.
...
`,
    methodology:
      "إذا كان $m$ يضيف حدًّا تربيعيًّا ($-mx^2$)، فإن $f_m''$ تعتمد على $m$، وموقع الأفصول لنقطة الانعطاف يتبدل بـ $m$.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "نقطة انعطاف", "تقعر", "تكعيبية"],
  },
  {
    ...
    statement:
      "لتكن $f_m(x) = (x - m)^2 e^{-x}$ على $\\mathbb{R}$. ناقش حسب $m$ القيمة الصغرى المطلقة لـ $f_m$.",
    hint: "احسب $f_m'$.",
    solution: `
...
`,
    methodology:
      "الدالة $(x - m)^2 e^{-x}$ لها دائماً قيمة صغرى = 0 عند $x = m$، لكن القيمة القصوى المحلية تعتمد على $m$.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "قيمة صغرى", "قيمة قصوى", "أسية", "مناقشة"],
  },
  {
    title: "معامل 40 — صحيح/خطأ حول التقعر بمعامل",
    statement:
      "هل العبارة صحيحة؟ «إذا كانت $f_m(x) = \\ln(x + m)$ مع $m > 0$ فإن $f_m$ مقعّرة على مجالها.»",
    hint: "احسب $f_m''$.",
    solution: `
...
`,
    methodology:
      "اللوغاريتم مقعّر دائماً على مجاله، بصرف النظر عن المعاملات الخطية. التحقق بحساب $f''$.",
    difficulty: "INTERMEDIATE",
    type: "TRUE_FALSE",
    points: 4,
    tags: ["معامل", "تقعر", "لوغاريتم", "صحيح/خطأ"],
  },
  {
    title: "معامل 41 — اختيار من متعدد: نقطة انعطاف",
    statement:
      "لتكن $f_m(x) = x^3 - 6x^2 + m x$. نقطة الانعطاف لـ $f_m$ عند الأفصول:\n\nA) $0$  \nB) $1$  \nC) $2$  \nD) $m$",
    hint: "حل $f_m''(x) = 0$.",
    solution: `
$f_m'(x) = 3x^2 - 12x + m$.
...
**ملاحظة:** الأرتوبويت $f_m(2) = 8 - 24 + 2m = 2m - 16$ يتغير حسب $m$.`,
    ...
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["معامل", "نقطة انعطاف", "اختيار من متعدد"],
  },
  {
    title: "معامل 42 — برهان: تأثير m على الرتابة",
    statement:
      "برهن أن الدالة $f_m(x) = x^2 + m$ تزايدية قطعاً على $[0, +\\infty[$ مهما كان $m$.",
    hint: "احسب $f_m'$.",
    solution: `
$f_m'(x) = 2x$.
...
`,
    methodology:
      "إذا كان $m$ إضافة فقط (دالة ثابتة)، فإن المشتقة لا تعتمد على $m$ والرتابة تبقى ثابتة.",
    difficulty: "BEGINNER",
    type: "DEMONSTRATION",
    points: 4,
    tags: ["معامل", "رتابة", "برهان"],
  },
  {
    title: "معامل 43 — مناقشة شاملة لدالة كسرية بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{mx + 1}{x - 1}$ على $D = \\mathbb{R} \\setminus \\{1\\}$. ناقش حسب $m$ رتابة $f_m$.",
...
`,
    methodology:
      "في الدوال الكسرية الخطية/خطية، المميز $ad - bc$ (هنا $m \\cdot 1 - 1 \\cdot (-1) = m + 1$) يحدد الرتابة. الانتباه للإشارة السالبة في الاشتقاق!",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "رتابة", "مناقشة", "كسرية"],
  },
  {
    title: "معامل 44 — مناقشة أقصى محلي بدلالة m",
    statement:
      "لتكن $f_m(x) = m x - x^2$ على $\\mathbb{R}$. ناقش حسب $m$ القيمة القصوى لـ $f_m$.",
    hint: "حل $f_m'(x) = 0$.",
    solution: `
...
`,
    methodology:
      "في التربيعية $-x^2 + mx$ القيمة القصوى $m^2/4$ (موجبة أو معدومة). ملاحظة: $a = -1 < 0$ إذن قيمة قصوى وليس صغرى.",
    difficulty: "INTERMEDIATE",
    type: "METHOD_EXERCISE",
    points: 5,
    tags: ["معامل", "قيمة قصوى", "تربيعية", "مناقشة"],
  },
  {
    title: "معامل 45 — مناقشة مزدوجة لمعاملين",
    statement:
      "لتكن $f_{m,n}(x) = \\dfrac{mx + n}{x - 1}$ على $\\mathbb{R} \\setminus \\{1\\}$. ادرس الرتابة بدلالة $m, n$.",
    hint: "حلل $f_{m,n}'$.",
    solution: `
...
`,
    methodology:
      "في الدالة الكسرية الخطية/خطية، الرتابة تعتمد على $ad - bc = m \\cdot (-1) - n \\cdot 1 = -(m + n)$ فقط. هذا يكشف دور المعاملات.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "مناقشة", "كسرية", "رتابة", "معاملان"],
  },
  {
    title: "معامل 46 — مناقشة تقعر دالة لوغاريتمية بمعامل",
    statement:
      "لتكن $f_m(x) = x \\ln(x) - m x$ على $]0, +\\infty[$. ناقش حسب $m$ القيمة الصغرى.",
    hint: "حلل $f_m'$.",
    solution: `
$f_m'(x) = \\ln(x) + 1 - m$.
...
`,
    methodology:
      "عند تركيب لوغاريتم وضرب بمعامل، القيمة الصغرى تأتي بشكل أُسي بدلالة $m$. القيمة $-e^{m-1}$ سالبة دائماً.",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "قيمة صغرى", "لوغاريتم", "أسية", "مناقشة"],
  },
  {
    title: "معامل 47 — مناقشة دالة تكعيبية معقدة",
    statement:
      "لتكن $f_m(x) = x^3 - 3x + m x = x^3 + (m - 3)x$. ناقش حسب $m$ رتابة $f_m$ على $\\mathbb{R}$.",
...
`,
    methodology:
      "في المناقشة، التغيير من «رتيبة على $\\mathbb{R}$» إلى «غير رتيبة» يحدث عند القيمة الحرجة $m = 3$ (حيث $\\Delta$ = 0).",
    difficulty: "ADVANCED",
    type: "METHOD_EXERCISE",
    points: 6,
    tags: ["معامل", "رتابة", "مناقشة", "تكعيبية"],
  },
  {
    title: "معامل 48 — صحيح/خطأ: نقطة انعطاف متغيرة",
    statement:
      "هل العبارة صحيحة؟ «إذا كانت $f_m(x) = x^3 + mx$ فإن $f_m$ لها نقطة انعطاف عند $x = 0$ مهما كان $m$.»",
    hint: "حل $f_m''(x) = 0$.",
    solution: `
$f_m'(x) = 3x^2 + m$.
...
**ملاحظة:** $m$ يضيف حدًّا خطيًّا، لا يؤثر على $f''$ (التي تعتمد على الحد التكعيبي فقط).`,
    ...
    type: "TRUE_FALSE",
    points: 3,
    tags: ["معامل", "نقطة انعطاف", "صحيح/خطأ"],
  },
  {
    title: "معامل 49 — اختيار من متعدد: تقابل بمعامل",
    statement:
      "لتكن $f_m(x) = x^2 + (m - 1)x + 1$. لأي قيمة $m$ تكون $f_m$ غير سالبة على $\\mathbb{R}$؟\n\nA) $m \\in [-1, 3]$  \nB) $m \\in [-3, 1]$  \nC) $m \\in \\mathbb{R}$  \nD) $m \\in \\emptyset$",
    hint: "ادرس المميز.",
    solution: `
...
`,
    methodology:
      "$f_m \\geq 0$ على $\\mathbb{R}$ (لـ $a > 0$) $\\iff$ $\\Delta \\leq 0$. نحل المتراجحة في $m$.",
    difficulty: "INTERMEDIATE",
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["معامل", "تقابل", "اختيار من متعدد", "مميز"],
  },
  {
    title: "معامل 50 — برهان: متباينة بدلالة m",
    statement:
      "برهن أنه لكل $x > 0$ وكل $m > 0$: $x + \\dfrac{m}{x} \\geq 2\\sqrt{m}$.",
...
`,
    methodology:
      "متباينة AM-GM (الوسط الحسابي ≥ الوسط الهندسي) تأتي مباشرة من دراسة القيمة الصغرى للدالة $x + m/x$. أداة قوية في البراهين.",
    difficulty: "ADVANCED",
    type: "DEMONSTRATION",
    points: 6,
    tags: ["معامل", "متباينة", "برهان", "AM-GM"],
  },

  // ----------------------------------------------------------
  //  القسم 5: الأمثلية (optimization) — 25 تمرين
  // ----------------------------------------------------------
  {
    title: "أمثلية 1 — تعظيم مساحة حظيرة",
    statement:
      "مزارع يملك 40 متراً من السياج لبناء حظيرة مستطيلة بجدار جانبي (لا يحتاج سياج). ما الأبعاد التي تعطي أكبر مساحة؟",
...
`,
    methodology:
      "خطوات الأمثلية: نمذجة → قيود → دالة الهدف بمتغير واحد → اشتقاق → حل النقاط الحرجة → تحقق بطبيعة القطب → استنتاج.",
    difficulty: "INTERMEDIATE",
    type: "PROBLEM",
    points: 7,
    tags: ["أمثلية", "مساحة", "هندسية"],
  },
  {
    title: "أمثلية 2 — تعظيم حجم صندوق",
    statement:
      "صندوق مفتوح من الأعلى مصنوع من صفيحة مربعة 30×30 cm بقص مربعات من الأركان. ما ارتفاع القص للحصول على أكبر حجم؟",
...
`,
    methodology:
      "في الأمثلية، نتحقق من القيود الفيزيائية (مجال الدالة). أحد الجذرين قد يكون خارج المجال، فلا يُعتبر.",
    difficulty: "INTERMEDIATE",
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "حجم", "هندسية", "جذران"],
  },
  {
    title: "أمثلية 3 — تصغير الكلفة",
    statement:
      "إنتاج $q$ وحدة من منتج له كلفة $C(q) = q^3 - 6q^2 + 15q + 10$. ما الإنتاج $q > 0$ الذي يصغّر الكلفة المتوسطة $\\bar{C}(q) = \\dfrac{C(q)}{q}$؟",
...
`,
    methodology:
      "للأمثلية الاقتصادية، الكلفة المتوسطة = $\\bar{C}(q) = C(q)/q$. نقسّم الكلفة الكلية على الكمية. حل المعادلة التكعيبية عددياً إن لزم.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "كلفة", "اقتصادية"],
  },
  {
    title: "أمثلية 4 — تعظيم مساحة مستطيل بمحيط معطى",
    statement:
      "أرض مستطيلة محيطها 100 m. ما الأبعاد التي تعطي أكبر مساحة؟",
...
**ملاحظة:** من بين كل المستطيلات بمحيط معطى، المربع له أكبر مساحة. هذا مثال على مبدأ التناظر في الأمثلية.`,
    ...
    type: "PROBLEM",
    points: 5,
    tags: ["أمثلية", "محيط", "مربع"],
  },
  {
    title: "أمثلية 5 — تصغير مجموع مسافتين",
    statement:
      "نقطة $A$ على خط ساحلي ونقطة $B$ في البحر على بعد 6 km من الساحل، عمودياً على نقطة $C$ على الساحل حيث $AC = 10$ km. يريد صياد الوصول من $A$ إلى $B$ بالسباحة (سرعة 2 km/h) ثم الجري على الساحل (سرعة 5 km/h). ما المسار الأسرع؟",
...
**الإجابة:** الصياد يجري على الساحل ~7.38 km ثم يسبح ~8.93 km (المسافة من $D$ إلى $B$) للوصول بأسرع زمن.`,
    ...
    type: "PROBLEM",
    points: 10,
    tags: ["أمثلية", "فيزيائية", "سرعة", "جذر"],
  },
  {
    title: "أمثلية 6 — تعظيم ربح اقتصادي",
    statement:
      "دالة الربح $B(q) = -q^2 + 100q - 100$ (بآلاف الدينارات). ما الإنتاج $q$ الذي يعظم الربح؟",
    hint: "حل $B'(q) = 0$.",
    solution: `
...
**ملاحظة:** دالة الربح التربيعية بمعامل سالب $a = -1 < 0$ لها قيمة قصوى مطلقة.`,
    ...
    type: "PROBLEM",
    points: 6,
    tags: ["أمثلية", "ربح", "اقتصادية"],
  },
  {
    title: "أمثلية 7 — تصغير سطح علبة",
    statement:
      "علبة أسطوانية حجمها $V = 1$ لتر ($1000 \\text{ cm}^3$). ما نصف القطر $r$ الذي يصغّر مساحة السطح الكلية؟",
...
- ملاحظة: $h \\approx 2r$ (العلبة بنفس الارتفاع والقطر في الأمثلية الكاملة).`,
    ...
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "أسطوانة", "حجم", "هندسية"],
  },
  {
    title: "أمثلية 8 — تصغير مسافة من نقطة إلى منحنى",
    statement:
      "ما النقطة على المنحنى $y = x^2$ الأقرب إلى النقطة $A(0, 1)$؟",
...
هذه نقطة خاصة لتمرين البكالوريا.`,
    ...
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "مسافة", "منحنى", "هندسية"],
  },
  {
    title: "أمثلية 9 — تعظيم مساحة مثلث",
    statement:
      "مثلث قاعدته 10 cm وارتفاعه $h$ متغير. محيط المثلث 30 cm. ما ارتفاعه الذي يعظم المساحة؟",
...
**الإجابة:** المثلث المتساوي الساقين (قاعدة 10، ضلعان 10) يعظم المساحة بمحيط 30 cm.`,
    ...
    type: "PROBLEM",
    points: 10,
    tags: ["أمثلية", "مثلث", "هيرون", "هندسية"],
  },
  {
    title: "أمثلية 10 — تعظيم حجم صندوق بدون غطاء بمساحة معطاة",
    statement:
      "صندوق بدون غطاء مساحة سطحه الكلية 1200 $\\text{cm}^2$، قاعدته مربعة. ما أبعاده التي تعظم الحجم؟",
...
هذا تمرين كلاسيكي في أمثلية البكالوريا.`,
    ...
    type: "PROBLEM",
    points: 9,
    tags: ["أمثلية", "حجم", "صندوق", "هندسية"],
  },
  {
    title: "أمثلية 11 — تعظيم طاقة",
    statement:
      "دالة الطاقة $E(x) = 100x - x^2$ (بوحدة Joule). ما قيمة $x$ التي تعظم الطاقة؟",
    hint: "حل $E'(x) = 0$.",
    solution: `
...
ملاحظة: هذا تطبيق بسيط للأمثلية في الفيزياء. الدالة تربيعية بمعامل سالب، القيمة القصوى عند $x = -b/(2a) = 100/2 = 50$.`,
    ...
    type: "PROBLEM",
    points: 4,
    tags: ["أمثلية", "طاقة", "فيزيائية"],
  },
  {
    title: "أمثلية 12 — تعظيم إنتاج",
    statement:
      "إنتاج محصول زراعي $y$ (طن) بدلالة كمية الماء $x$ (متر مكعب): $y = -0.01 x^2 + 2x - 50$. ما كمية الماء المثلى؟",
    hint: "حل $y' = 0$.",
    solution: `
...
ملاحظة: الزيادة في الماء بعد هذه القيمة تنقص الإنتاج (ظاهرة معروفة في الزراعة).`,
    ...
    type: "PROBLEM",
    points: 5,
    tags: ["أمثلية", "زراعية", "إنتاج"],
  },
  {
    title: "أمثلية 13 — تصغير طول قطعة",
    statement:
      "من نقطة $A$ على خط $\\ell_1$ إلى نقطة $B$ على خط $\\ell_2$ موازٍ لـ $\\ell_1$ على بعد 8 m. المسافة الأفقية بين $A$ و $B$ هي 15 m. ما أقصر مسار يمر بنقطة على $\\ell_1$ ثم $\\ell_2$؟",
...
هذا مثال على تطبيق نظرية فيثاغورس في الأمثلية.`,
    ...
    type: "PROBLEM",
    points: 5,
    tags: ["أمثلية", "مسافة", "فيلاغورس"],
  },
  {
    title: "أمثلية 14 — تعظيم ربح بدالة كسرية",
    statement:
      "دالة الربح $B(x) = \\dfrac{x^2 - 10x + 25}{x + 1}$ (لـ $x > 0$). ما قيمة $x$ التي تعظم الربح؟",
...
**ملاحظة:** عند $x = 5$ الربح = 0 (نقطة التعادل). الدالة تزايدية حتى 5 ثم تتناقص، لكنها دائماً $\\geq 0$.`,
    ...
    type: "PROBLEM",
    points: 7,
    tags: ["أمثلية", "ربح", "كسرية", "تحليل"],
  },
  {
    title: "أمثلية 15 — تعظيم مساحة مثلث في دائرة",
    statement:
      "مثلث قائم محاط في دائرة نصف قطرها $R = 5$. ما أبعاده التي تعظم مساحته؟",
...
ملاحظة: هذا تطبيق لمتباينة AM-GM في الأمثلية الهندسية.`,
    ...
    type: "PROBLEM",
    points: 7,
    tags: ["أمثلية", "مثلث قائم", "دائرة", "AM-GM"],
  },
  {
    title: "أمثلية 16 — تعظيم زاوية",
    statement:
      "تمثال بارتفاع 3 m على قاعدة بارتفاع 2 m. المشاهد يقف على بعد $x$ m من القاعدة. ما $x$ الذي يعظم الزاوية $\\theta$ التي يرى بها التمثال؟",
...
هذا تمرين كلاسيكي في أمثلية البكالوريا يسمى «مشكلة التمثال».`,
    ...
    type: "PROBLEM",
    points: 12,
    tags: ["أمثلية", "زاوية", "تمثال", "بكالوريا", "تريغونومتري"],
  },
  {
    title: "أمثلية 17 — تعظيم مساحة مستطيل داخل مثلث",
    statement:
      "مستطيل داخل مثلث قائم الزاوية، ضلعاه على ضلعين قائمتين. المثلث أبعاده 6 و 8 و 10. ما أبعاد المستطيل الأكبر مساحة؟",
...
ملاحظة: المستطيل الأكبر داخل مثلث قائم يكون بأبعاد نصف ضلعي القائمة.`,
    ...
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "مستطيل", "مثلث", "هندسية"],
  },
  {
    title: "أمثلية 18 — صحيح/خطأ",
    statement:
      "هل العبارة صحيحة؟ «القيمة القصوى للدالة $f(x) = x(20 - x)$ على $[0, 20]$ تساوي 100.»",
    hint: "حل $f'(x) = 0$.",
    solution: `
$f(x) = 20x - x^2$.
...
القيمة القصوى = 100 عند $x = 10$.`,
    ...
    type: "TRUE_FALSE",
    points: 3,
    tags: ["أمثلية", "قيمة قصوى", "صحيح/خطأ"],
  },
  {
    title: "أمثلية 19 — اختيار من متعدد: تصغير",
    statement:
      "لتكن $f(x) = x + \\dfrac{4}{x}$ على $]0, +\\infty[$. القيمة الصغرى المطلقة لـ $f$ تساوي:\n\nA) $2$  \nB) $4$  \nC) $8$  \nD) $16$",
    hint: "حل $f'(x) = 0$.",
    solution: `
...
الإجابة الصحيحة: **B**.`,
    ...
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["أمثلية", "قيمة صغرى", "اختيار من متعدد"],
  },
  {
    title: "أمثلية 20 — برهان خاصية AM-GM",
    statement:
      "برهن أن لكل $x, y > 0$: $\\dfrac{x + y}{2} \\geq \\sqrt{xy}$. التساوي عند $x = y$.",
...
**النتيجة:** AM-GM مثبتة ✓.`,
    ...
    type: "DEMONSTRATION",
    points: 6,
    tags: ["أمثلية", "برهان", "AM-GM", "متباينة"],
  },
  {
    title: "أمثلية 21 — تعظيم ربح بدالة معقدة",
    statement:
      "دالة الربح $B(q) = -q^3 + 30q^2 - 225q + 200$ (لـ $q \\geq 0$). ناقش ربح الإنتاج الأمثل.",
    hint: "حل $B'(q) = 0$.",
    solution: `
...
ملاحظة: عند $q = 5$ هناك خسارة محلية (لا يجب الإنتاج بهذه الكمية).`,
    ...
    type: "PROBLEM",
    points: 9,
    tags: ["أمثلية", "ربح", "اقتصادية", "جدول تغيرات"],
  },
  {
    title: "أمثلية 22 — تعظيم دخل بدالة أسية",
    statement:
      "دالة الدخل $R(x) = x \\cdot e^{-0.1 x}$ (لـ $x \\geq 0$). ما $x$ الذي يعظم الدخل؟",
    hint: "حل $R'(x) = 0$.",
    solution: `
...
ملاحظة: هذا تطبيق للأمثلية مع الدوال الأسية، شائع في الاقتصاد (نموذج الإنتاج المثبط).`,
    ...
    type: "PROBLEM",
    points: 6,
    tags: ["أمثلية", "دخل", "أسية", "اقتصادية"],
  },
  {
    title: "أمثلية 23 — تصغير زمن بدالة جذر",
    statement:
      "قارب يبحر بسرعة $v$ km/h، يستهلك وقوداً بمقدار $\\dfrac{v^2}{100}$ لتر/km. الرحلة 200 km. ما السرعة المثلى لتصغير الكلفة الكلية إذا ثمن الوقود 50 دج/لتر؟",
...
**الإجابة:** السرعة المثلى $v = \\sqrt[3]{p}$ km/h، تعتمد على القيمة الزمنية $p$.`,
    ...
    type: "PROBLEM",
    points: 8,
    tags: ["أمثلية", "كلفة", "زمن", "اقتصادية"],
  },
  {
    title: "أمثلية 24 — اختيار من متعدد: تعظيم",
    statement:
      "لتكن $f(x) = -x^2 + 6x - 5$. القيمة القصوى المطلقة لـ $f$ على $\\mathbb{R}$ تساوي:\n\nA) $-5$  \nB) $0$  \nC) $4$  \nD) $9$",
    hint: "حل $f'(x) = 0$.",
    solution: `
...
الإجابة الصحيحة: **C**.`,
    ...
    type: "MULTIPLE_CHOICE",
    points: 2,
    tags: ["أمثلية", "قيمة قصوى", "اختيار من متعدد"],
  },
  {
    title: "أمثلية 25 — برهان: متباينة المثلث",
    statement:
      "برهن أنه لكل $x, y \\in \\mathbb{R}$: $|x + y| \\leq |x| + |y|$ (متباينة المثلث).",
...
`,
    methodology:
      "دراسة شاملة بمعامل تجمع: نهايات مستقلة، اشتقاق بمناقشة المميز، حالات خاصة $m = 1$ (فجوة) و $m = 0$ (جدول). منهجية بكالوريا.",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 14,
    tags: ["معامل", "دراسة شاملة", "مناقشة", "مميز", "بكالوريا"],
  },
  {
    title: "شامل بمعامل 2 — مناقشة بثلاث حالات",
    statement:
      "لتكن $f_m(x) = x^3 - 3m x + m$ على $\\mathbb{R}$.\n\n1. اشتق $f_m$ وادرس إشارتها حسب $m$.\n2. ناقش حسب $m$ عدد حلول المعادلة $f_m(x) = 0$.\n3. في حالة $m > 0$، احسب قيم القطبين بدلالة $m$.",
...
`,
    methodology:
      "مناقشة كاملة بثلاث حالات حسب $m$: الرتابة تتغير عند $m = 0$، وعدد الحلول يتغير عند $m = 1/4$. القيم الحرجة المزدوجة تجعل المسألة غنية.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 16,
    tags: ["معامل", "مناقشة", "حل معادلة", "تكعيبية", "بكالوريا"],
  },
  {
    title: "شامل بمعامل 3 — دالة أسية بمعامل",
    statement:
      "لتكن $f_m(x) = e^{x} - m x$ على $\\mathbb{R}$ (مع $m > 0$).\n\n1. اشتق $f_m$ وادرس إشارتها.\n2. ناقش حسب $m$ عدد حلول $f_m(x) = 0$.\n3. ما القيمة الحرجة $m_0$؟ حدد ما يحدث عند $m = m_0$.",
...
`,
    methodology:
      "هذه المسألة كلاسيكية في البكالوريا: مناقشة عدد حلول $e^x = mx$ حسب $m$. القيمة الحرجة $m = e$ تأتي من $\\ln m = 1$.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 15,
    tags: ["معامل", "أسية", "مناقشة", "حل معادلة", "بكالوريا"],
  },
  {
    title: "شامل بمعامل 4 — دالة لوغاريتم بمعامل",
    statement:
      "لتكن $f_m(x) = x - m \\ln(x)$ على $]0, +\\infty[$ (مع $m > 0$).\n\n1. اشتق $f_m$ وادرس إشارتها.\n2. احسب القيمة الصغرى المطلقة بدلالة $m$.\n3. ناقش حسب $m$ عدد حلول $f_m(x) = 0$.",
    hint: "حل $f_m'(x) = 1 - m/x$.",
    solution: `
**1. الاشتقاق:**
...
`,
    methodology:
      "هذا تمرين بمعاملين يجمع الرؤية الجبرية والهندسية. المنحنى $a = b^2/4$ (قطع مكافئ) يقسم المستوى.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 8,
    tags: ["معاملان", "تربيعية", "مميز", "مناقشة"],
  },
  {
    title: "شامل بمعامل 6 — تقابل بمعامل",
    statement:
      "لتكن $f_m(x) = x^3 + m x^2$ على $\\mathbb{R}$. ناقش حسب $m$ تقابل $f_m$ على $\\mathbb{R}$.",
...
`,
    methodology:
      "في مناقشة التقابل بمعامل، القيمة الحرجة تأتي من انعدام الجذور في $f_m'$. هنا $m = 0$ يجعل الجذرين مزدوجين في $x = 0$.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 7,
    tags: ["معامل", "تقابل", "رتابة", "مناقشة", "تكعيبية"],
  },
  {
    title: "شامل بمعامل 7 — مقاربة مائلة بمعامل",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 + m x + 1}{x - 2}$ على $D = \\mathbb{R} \\setminus \\{2\\}$.\n\n1. ادرس النهايات والمقاربات بدلالة $m$.\n2. اشتق $f_m$ وادرس إشارتها حسب $m$.\n3. ادرس موضع الرسم بالنسبة للمقاربة المائلة.",
...
`,
    methodology:
      "دراسة شاملة بمعامل في الدوال الكسرية: القسمة الإقليدية تعطي المقاربة المائلة، المميز يحدد الرتابة، إشارة الباقي تحدد الموضع.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 16,
    tags: ["معامل", "مقاربة مائلة", "موضع الرسم", "مناقشة", "بكالوريا"],
  },
  {
    title: "شامل بمعامل 8 — أمثلية بمعامل",
    statement:
      "مستطيل محيطه $2P$ ثابت. أحد ضلعيه $x$. ادرس مساحته $S(x) = x(P - x)$.\n\n1. ما قيمة $x$ التي تعظم المساحة؟\n2. هل القيمة القصوى تعتمد على $P$؟\n3. ماذا يحدث إذا افترضنا أن $x$ على $[0, P/2]$ (قيد إضافي)؟",
    hint: "حل $S'(x) = 0$.",
    solution: `
**1. تعظيم المساحة:**
...
`,
    methodology:
      "مستطيل بمحيط ثابت: المربع هو الأكبر مساحة. هذا مثال كلاسيكي على مبدأ التناظر في الأمثلية.",
    difficulty: "INTERMEDIATE",
    type: "PROBLEM",
    points: 6,
    tags: ["أمثلية", "محيط", "مربع", "معامل P"],
  },
  {
    title: "شامل بمعامل 9 — مناقشة دالة بمعامل",
    statement:
      "لتكن $f_m(x) = (x - m)^2 e^{-x}$ على $\\mathbb{R}$.\n\n1. ادرس نهايات $f_m$ عند $\\pm\\infty$ (مستقلة عن $m$؟).\n2. اشتق $f_m$ وادرس إشارتها.\n3. ادرس القيمة الصغرى المطلقة.\n4. ما القيمة القصوى المحلية بدلالة $m$؟",
...
`,
    methodology:
      "القيمة الصغرى 0 دائماً عند $x = m$، لكن القيمة القصوى المحلية $4 e^{-m-2}$ تعتمد على $m$. الدالة $f_m$ لها «قبتان» على جانبَي $x = m$.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 10,
    tags: ["معامل", "أسية", "قيمة صغرى", "قيمة قصوى", "مناقشة"],
  },
  {
    title: "شامل بمعامل 10 — تقابل بمعامل على مجال",
    statement:
      "لتكن $f_m(x) = \\dfrac{x - m}{x + m}$ على $]-m, +\\infty[$ (مع $m > 0$). برهن أن $f_m$ تقابل على هذا المجال وحدد $f_m^{-1}$.",
    hint: "ادرس رتابة $f_m$.",
    solution: `
...
`,
    methodology:
      "لإيجاد الدالة العكسية، نحل المعادلة $y = f(x)$ في $x$. نتحقق بحساب $f^{-1}(f(x)) = x$.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 8,
    tags: ["معامل", "تقابل", "دالة عكسية", "كسرية"],
  },
  {
    ...
    statement:
      "لتكن $f_m(x) = \\sqrt{m - x^2}$ (مع $m > 0$). ادرس المجال والقيمة القصوى.",
    hint: "حل $m - x^2 \\geq 0$.",
    solution: `
**مجال التعريف:**
...
`,
    methodology:
      "الدالة $\\sqrt{m - x^2}$ على $[-\\sqrt{m}, \\sqrt{m}]$ تمثل نصف دائرة علوية بنصف قطر $\\sqrt{m}$. القيمة القصوى $\\sqrt{m}$ عند $x = 0$.",
    difficulty: "INTERMEDIATE",
    type: "PROBLEM",
    points: 6,
    tags: ["معامل", "مجال التعريف", "جذر", "دائرة"],
  },
  {
    title: "شامل بمعامل 12 — مناقشة حلول تكعيبية",
    statement:
      "لتكن $f_m(x) = x^3 - 3x^2 + m$. ناقش حسب $m$ عدد حلول المعادلة $f_m(x) = 0$.",
    hint: "ادرس $f_m$ كاملة.",
    solution: `
...
`,
    methodology:
      "نطبق TVI على كل مجال رتيب. القيم الحرجة $m = 0$ و $m = 4$ تأتي من مساواة القطبين بالصفر. هذا سؤال بكالوريا كلاسيكي.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 14,
    tags: ["معامل", "حل معادلة", "مناقشة", "TVI", "تكعيبية", "بكالوريا"],
  },
  {
    title: "شامل بمعامل 13 — مناقشة دالة أصلية",
    statement:
      "لتكن $g_m(x) = 6x - 2m$ ولتكن $f_m$ الدالة الأصلية لـ $g_m$ مع $f_m(0) = 1$. ادرس تغيرات $f_m$ بدلالة $m$.",
...
`,
    methodology:
      "دراسة دالة أصلية: التكامل يعطي $f_m$، ثم نطبق عليها منهجية الدراسة (رتابة، قيمة صغرى).",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 8,
    tags: ["معامل", "دالة أصلية", "رتابة", "تربيعية"],
  },
  {
    title: "شامل بمعامل 14 — مناقشة عدد حلول معادلة",
    statement:
      "ناقش حسب $m \\in \\mathbb{R}$ عدد حلول المعادلة: $\\dfrac{1}{x} = m x - 2$.",
...
`,
    methodology:
      "هذه مسألة بكالوريا كاملة. المناقشة بمعامل تكتشف القيم الحرجة $m = 0$ و $m = -1$. كل قيمة تغير عدد الحلول على جانب مختلف من المجال.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 16,
    tags: ["معامل", "مناقشة", "حل معادلة", "TVI", "بكالوريا", "كسرية"],
  },
  {
    title: "شامل بمعامل 15 — تركيب دالتين",
    statement:
      "لتكن $g(x) = x^2 - 2x$ و $f_m(x) = g(x + m)$. ادرس تغيرات $f_m$ بدلالة $m$.",
...
`,
    methodology:
      "التركيب $f_m(x) = g(x + m)$ يعادل تحويل $g$ أفقياً بمقدار $-m$. القيم القصوى/الصغرى للقيم لا تتغير، فقط مواقعها.",
    difficulty: "ADVANCED",
    type: "PROBLEM",
    points: 8,
    tags: ["معامل", "تركيب", "تحويل أفقي", "تربيعية"],
  },

  // ----------------------------------------------------------
  //  القسم 7: تمارين متقدمة بكالوريا — 10 تمرين
  // ----------------------------------------------------------
  {
    title: "بكالوريا 1 — دالة بمعامل ومناقشة شاملة",
    statement:
      "لتكن $f_m(x) = \\dfrac{x - m}{x^2 - 1}$ على $D = \\mathbb{R} \\setminus \\{-1, 1\\}$.\n\n1. ادرس المقاربات بدلالة $m$.\n2. اشتق $f_m$ وادرس إشارتها.\n3. ناقش حسب $m$ عدد حلول $f_m(x) = 0$.\n4. في حالة $m = 0$، ادرس موضع الرسم بالنسبة لمقاربته الأفقية.",
...
`,
    methodology:
      "هذه دراسة شاملة بمعامل من نوع بكالوريا: مناقشة المقاربات (مع حالات خاصة للفجوة)، الاشتقاق، حلول $f_m = 0$.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 15,
    tags: ["بكالوريا", "معامل", "مناقشة", "مقاربات", "فجوة"],
  },
  {
    title: "بكالوريا 2 — تطبيق فيزيائي للأمثلية",
    statement:
      "قذيفة تطلق بزاوية $\\alpha$ مع الأفق بسرعة ابتدائية $v_0$. مدى الرمية $R = \\dfrac{v_0^2 \\sin(2\\alpha)}{g}$ (حيث $g$ ثقالة).\n\n1. ما الزاوية $\\alpha$ التي تعظم المدى؟\n2. ما القيمة القصوى للمدى؟\n3. لماذا $\\alpha = 45°$ الحل المثالي؟",
...
ملاحظة: في الواقع، تأثيرات مقاومة الهواء تجعل الزاوية المثلى الفعلية أصغر قليلاً من 45°.`,
    methodology:
      "هذا تطبيق كلاسيكي للأمثلية في الفيزياء (القذائف). الزاوية 45° تعطي أقصى مدى في الفراغ.",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 8,
    tags: ["بكالوريا", "أمثلية", "فيزياء", "زاوية", "تريغونومتري"],
  },
  {
    title: "بكالوريا 3 — مناقشة دالة أسية بمعامل",
    statement:
      "لتكن $f_m(x) = e^{mx} - e^x$ على $\\mathbb{R}$ (مع $m > 0$ و $m \\neq 1$).\n\n1. ادرس نهايات $f_m$ عند $\\pm\\infty$ حسب $m$.\n2. اشتق $f_m$ وادرس إشارتها.\n3. ناقش حسب $m$ إشارة $f_m$ على $\\mathbb{R}$.",
...
`,
    methodology:
      "هذا تمرين بكالوريا كلاسيكي على مقارنة أسيتين بمعاملات. القيمة $m = 1$ هي القيمة الحرجة (تنعدم فيها الدالة).",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 12,
    tags: ["بكالوريا", "أسية", "مناقشة", "إشارة"],
  },
  {
    title: "بكالوريا 4 — مناقشة دالة بمعامل على مجال محدود",
    statement:
      "لتكن $f_m(x) = m x - x^3$ على $[0, +\\infty[$ (مع $m > 0$). ناقش حسب $m$ عدد حلول $f_m(x) = 0$ على المجال.",
...
إذن القيمة القصوى موجبة، والدالة من 0 ترتفع إلى القيمة القصوى ثم تنزل إلى 0 عند $\\sqrt{m}$، ثم تذهب إلى $-\\infty$.`,
    ...
    type: "PROBLEM",
    points: 8,
    tags: ["بكالوريا", "معامل", "حل معادلة", "تكعيبية", "مجال محدود"],
  },
  {
    title: "بكالوريا 5 — صحيح/خطأ: مناقشة عامة",
    statement:
      "هل العبارة صحيحة؟ «إذا كانت $f_m$ رتيبة قطعاً على $\\mathbb{R}$ لكل $m > 0$ فإن $f_m$ تقابل على $\\mathbb{R}$.»",
...
العبارة **صحيحة** إذا أضفنا شرط $\\lim_{x \\to \\pm\\infty} f_m = \\pm\\infty$ (لضمان المجال المستقر $= \\mathbb{R}$).`,
    ...
    type: "TRUE_FALSE",
    points: 4,
    tags: ["بكالوريا", "تقابل", "صحيح/خطأ", "رتابة"],
  },
  {
    title: "بكالوريا 6 — اختيار من متعدد شامل",
    statement:
      "لتكن $f_m(x) = x^2 - 2mx + m^2 - 1 = (x - m)^2 - 1$. ما عدد القيم القصوى/الصغرى المحلية لـ $f_m$؟\n\nA) 0  \nB) 1  \nC) 2  \nD) يعتمد على $m$",
    hint: "حل $f_m'(x) = 0$.",
    solution: `
...
ملاحظة: $f_m(m) = -1$ (القيمة الصغرى دائماً -1، مستقلة عن $m$).`,
    ...
    type: "MULTIPLE_CHOICE",
    points: 3,
    tags: ["بكالوريا", "معامل", "قيمة صغرى", "اختيار من متعدد"],
  },
  {
    title: "بكالوريا 7 — دالة بمعامل ومناقشة مميز",
    statement:
      "لتكن $f_m(x) = \\dfrac{x^2 + m x + 4}{x + 1}$. ناقش حسب $m$ عدد النقاط الحرجة لـ $f_m$.",
...
**ملاحظة:** السعر $p_0 = 22$ هو نقطة التعادل، فوقها يصبح الإنتاج مربحاً.`,
    methodology:
      "هذا تمرين كامل في الاقتصاد: الربح = الإيراد - الكلفة. تعظيم الربح يأتي من حل $B' = 0$. نقطة التعادل من $B = 0$.",
    difficulty: "BAC_LEVEL",
    type: "PROBLEM",
    points: 12,
    tags: ["بكالوريا", "أمثلية", "اقتصادية", "ربح", "نقطة تعادل"],
  },
  {
    title: "بكالوريا 9 — برهان متباينة بمحدّبية",
    statement:
      "برهن متباينة ينسن: إذا كانت $f$ محدّبة على $I$ و $x_1, \\ldots, x_n \\in I$ و $\\lambda_1, \\ldots, \\lambda_n \\geq 0$ مع $\\sum \\lambda_i = 1$، فإن:\n$$f\\left(\\sum_{i=1}^n \\lambda_i x_i\\right) \\leq \\sum_{i=1}^n \\lambda_i f(x_i)$$",
...
`,
    methodology:
      "هذه دراسة شاملة كاملة من نوع البكالوريا: مقاربات (مع فجوة)، اشتقاق، مناقشة المميز، حالات ثلاثة حسب $m$، موضع الرسم. القيمة الحرجة $m = -1$ تجمع كل التحولات.",
    difficulty: "BAC_EXAM",
    type: "PROBLEM",
    points: 18,
    tags: ["بكالوريا", "معامل", "دراسة شاملة", "مناقشة", "مقاربة مائلة", "موضع الرسم", "فجوة"],
  },
];
